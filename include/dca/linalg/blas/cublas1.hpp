...
inline void swap(cublasHandle_t handle, int n, std::complex<float>* x, int incx, std::complex<float>* y, int incy) {
...
inline void swap(cublasHandle_t handle, int n, std::complex<double>* x, int incx, std::complex<double>* y, int incy) {
...
inline void scal(cublasHandle_t handle, int n, std::complex<float> alpha, std::complex<float>* x, int incx) {
...
inline void scal(cublasHandle_t handle, int n, std::complex<double> alpha, std::complex<double>* x, int incx) {
...
inline void copy(cublasHandle_t handle, int n, const std::complex<float>* x, int incx, std::complex<float>* y, int incy) {
  const cuComplex* cu_x = reinterpret_cast<const cuComplex*>(x);
  cuComplex* cu_y = reinterpret_cast<cuComplex*>(y);
  cublasStatus_t status = cublasCcopy(handle, n, cu_x, incx, cu_y, incy);
  cublasCheckReturnCode(status);
}
inline void copy(cublasHandle_t handle, int n, const std::complex<double>* x, int incx, std::complex<double>* y, int incy) {
