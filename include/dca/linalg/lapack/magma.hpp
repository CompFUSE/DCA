...
inline void magmablas_gemm_vbatched(const char transa, const char transb, int* m, int* n, int* k,
                                    ...
                                    int* ldc, const int batch_count, const magma_queue_t queue) {
  magmablas_cgemm_vbatched(toMagmaTrans(transa), toMagmaTrans(transb), m, n, k, castCuda(alpha),
                           castCuda(a), lda, castCuda(b), ldb, castCuda(beta), castCuda(c), ldc,
                           batch_count, queue);
  checkErrorsCudaDebug();
}
inline void magmablas_gemm_vbatched(const char transa, const char transb, int* m, int* n, int* k,
                                    ...
                                    int* ldc, const int batch_count, const magma_queue_t queue) {
  magmablas_zgemm_vbatched(toMagmaTrans(transa), toMagmaTrans(transb), m, n, k, castCuda(alpha),
                           castCuda(a), lda, castCuda(b), ldb, castCuda(beta), castCuda(c), ldc,
                           batch_count, queue);
  checkErrorsCudaDebug();
}
...
inline void magmablas_gemm_vbatched_max_nocheck(
  ...
  magmablas_cgemm_vbatched_max_nocheck(
      toMagmaTrans(transa), toMagmaTrans(transb), m, n, k, castCuda(alpha), castCuda(a), lda,
      castCuda(b), ldb, castCuda(beta), castCuda(c), ldc, batch_count, m_max, n_max, k_max, queue);
  checkErrorsCudaDebug();
}
...
inline void magmablas_gemm_batched(const char transa, const char transb, const int m, const int n,
  ...
  magmablas_cgemm_batched(toMagmaTrans(transa), toMagmaTrans(transb), m, n, k, castCuda(alpha),
                          castCuda(a), lda, castCuda(b), ldb, castCuda(beta), castCuda(c), ldc,
                          batch_count, queue);
  checkErrorsCudaDebug();
}
inline void magmablas_gemm_batched(const char transa, const char transb, const int m, const int n,
                                   ...
                                   const std::complex<double> beta, std::complex<double>** c,
                                   const int ldc, const int batch_count, const magma_queue_t queue) {
  magmablas_zgemm_batched(toMagmaTrans(transa), toMagmaTrans(transb), m, n, k, castCuda(alpha),
                          castCuda(a), lda, castCuda(b), ldb, castCuda(beta), castCuda(c), ldc,
                          batch_count, queue);
  checkErrorsCudaDebug();
}
