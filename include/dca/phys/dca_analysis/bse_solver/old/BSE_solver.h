...
//     }
  ...
  */
  ...
  void BSE_solver<parameters_type, MOMS_type>::calculate_susceptibilities_2()
  {
    ...
    {
      //BSE_lattice_solver_obj.compute_Gamma_lattice_2(Gamma_cluster);
  ...
  /*
  template<class parameters_type, class MOMS_type>
  void BSE_solver<parameters_type, MOMS_type>::load_the_matrices()
  {
    profiler_t prof(__FUNCTION__, __FILE__, __LINE__);
  ...
  */
  ...
  /*
  template<class parameters_type, class MOMS_type>
  void BSE_solver<parameters_type, MOMS_type>::compute_Gamma_cluster()
  {
    profiler_t prof(__FUNCTION__, __FILE__, __LINE__);
  ...
  */
  ...
  /*
  template<class parameters_type, class MOMS_type>
  void BSE_solver<parameters_type, MOMS_type>::compute_Gamma_lattice()
  {
    profiler_t prof(__FUNCTION__, __FILE__, __LINE__);
  ...
  */
  ...
  /*
  template<class parameters_type, class MOMS_type>
  void BSE_solver<parameters_type, MOMS_type>::compute_chi_0()
  {
    profiler_t prof(__FUNCTION__, __FILE__, __LINE__);
...
//   template<class parameters_type, class MOMS_type>
//   void BSE_solver<parameters_type, MOMS_type>::diagonolize_Gamma_times_chi_tmp()
//   {
...
/*
  template<class parameters_type, class MOMS_type>
  void BSE_solver<parameters_type, MOMS_type>::diagonolize_Gamma_times_chi_0()
  {
...
/*
  template<class parameters_type, class MOMS_type>
  void BSE_solver<parameters_type, MOMS_type>::diagonolize_Gamma_times_chi_0_general()
  {
    profiler_t prof(__FUNCTION__, __FILE__, __LINE__);
...
/*
  template<class parameters_type, class MOMS_type>
  void BSE_solver<parameters_type, MOMS_type>::find_harmonic_expansion()
  {
    profiler_t prof(__FUNCTION__, __FILE__, __LINE__);
...
/*
  template<class parameters_type, class MOMS_type>
  void BSE_solver<parameters_type, MOMS_type>::write_on_shell()
  {
    profiler_t prof(__FUNCTION__, __FILE__, __LINE__);
...
/*
  template<class parameters_type, class MOMS_type>
  void BSE_solver<parameters_type, MOMS_type>::compute_P_q_cluster()
  {
    profiler_t prof(__FUNCTION__, __FILE__, __LINE__);
...
*/
  ...
  /*
  template<class parameters_type, class MOMS_type>
  void BSE_solver<parameters_type, MOMS_type>::compute_P_q_lattice()
  {
    profiler_t prof(__FUNCTION__, __FILE__, __LINE__);
