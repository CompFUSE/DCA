...
private:
  ...
  static const inline G0Interpolation<device, Scalar>* g0_ = nullptr;
...
template <class Parameters, typename Scalar, DeviceType device>
TimeCorrelator<Parameters, Scalar, device>::TimeCorrelator(const Parameters& parameters_ref, int id)
