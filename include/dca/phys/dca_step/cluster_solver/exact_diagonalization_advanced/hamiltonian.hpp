...
template <typename parameters_type, typename ed_options>
void Hamiltonian<parameters_type, ed_options>::add_V_to_Hamiltonian(
    int /*N*/, matrix_type& H, const Hilbert_space_type& subspace) {
...
template <typename parameters_type, typename ed_options>
void Hamiltonian<parameters_type, ed_options>::add_T_to_Hamiltonian(
    int /*N*/, matrix_type& H, const Hilbert_space_type& subspace) {
  const Hilbert_space_phi_representation_type& rep = subspace.get_rep();
...
template <typename parameters_type, typename ed_options>
void Hamiltonian<parameters_type, ed_options>::add_U_to_Hamiltonian(
    int N, matrix_type& H, const Hilbert_space_type& subspace) {
  const Hilbert_space_phi_representation_type& rep = subspace.get_rep();
