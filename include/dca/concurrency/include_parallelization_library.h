//-*-C++-*-
#ifndef COMP_LIBRARY_PARALLELIZATION_LIBRARY_INCLUDE_PARALLELIZATION_LIBRARY_H
#define COMP_LIBRARY_PARALLELIZATION_LIBRARY_INCLUDE_PARALLELIZATION_LIBRARY_H
