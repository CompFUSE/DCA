...
#ifndef DCA_CONCURRENCY_PROCESSOR_GROUPING_INTERFACE_PTHREADS_H
#define DCA_CONCURRENCY_PROCESSOR_GROUPING_INTERFACE_PTHREADS_H
...
#endif  // DCA_CONCURRENCY_PROCESSOR_GROUPING_INTERFACE_PTHREADS_H
