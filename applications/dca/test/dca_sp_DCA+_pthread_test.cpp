...
// generated by cmake, contains definitions from build time
...
TEST(dca_sp_DCAplus_pthread, Self_energy) {
  ...
  if (dca_test_env->concurrency.id() == dca_test_env->concurrency.first()) {
    ...
    reader.open_file( DCA_SOURCE_DIRECTORY "/applications/dca/test/check_data.dca_sp_DCA+_pthread_test.hdf5");
...
int main(int argc, char** argv) {
  ...
  dca_test_env = new dca_mpi_test_environment(
      argc, argv, DCA_SOURCE_DIRECTORY "/applications/dca/test/input.dca_sp_DCA+_pthread_test.json");
