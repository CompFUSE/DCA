...
typedef cluster_domain_family<double, lattice_type::DIMENSION, LATTICE_SP, BRILLOUIN_ZONE>
    HOST_sp_cluster_family_type;
typedef cluster_domain_family<double, lattice_type::DIMENSION, LATTICE_TP, BRILLOUIN_ZONE>
    HOST_tp_cluster_family_type;

typedef cluster_domain<double, lattice_type::DIMENSION, LATTICE_SP, MOMENTUM_SPACE, PARALLELLEPIPEDUM>
    LDA_k_cluster_type;
typedef cluster_domain<double, lattice_type::DIMENSION, CLUSTER, MOMENTUM_SPACE, BRILLOUIN_ZONE>
    DCA_k_cluster_type;
typedef cluster_domain<double, lattice_type::DIMENSION, CLUSTER, MOMENTUM_SPACE, BRILLOUIN_ZONE>
    PCM_k_cluster_type;
typedef cluster_domain<double, lattice_type::DIMENSION, LATTICE_SP, MOMENTUM_SPACE, BRILLOUIN_ZONE>
    host_k_cluster_type;

typedef cluster_domain<double, lattice_type::DIMENSION, LATTICE_TP, MOMENTUM_SPACE, BRILLOUIN_ZONE>
    host_vertex_k_cluster_type;

typedef cluster_domain<double, lattice_type::DIMENSION, LATTICE_SP, REAL_SPACE, PARALLELLEPIPEDUM>
    LDA_r_cluster_type;
...
typedef cluster_domain<double, lattice_type::DIMENSION, LATTICE_SP, REAL_SPACE, BRILLOUIN_ZONE>
    host_r_cluster_type;

typedef cluster_domain<double, lattice_type::DIMENSION, LATTICE_TP, REAL_SPACE, BRILLOUIN_ZONE>
    host_vertex_r_cluster_type;
...
typedef rng::ranq2 random_number_generator;  // use old, quick rng
...
typedef dmn_2<b_b_k_DCA_w_VERTEX_EXTENDED, b_b_k_DCA_w_VERTEX_EXTENDED>
    b_b_k_DCA_w_VERTEX_EXTENDED__b_b_k_DCA_w_VERTEX_EXTENDED;
