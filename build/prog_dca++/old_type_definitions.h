...
const static cluster_representation_type VERTEX_cluster_representation = FULL;//IRREDUCIBLE; 
...
typedef vertex_frequency_domain<COMPACT>               compact_vertex_frequency_domain_type;
typedef vertex_frequency_domain<EXTENDED>              extended_vertex_frequency_domain_type;
typedef vertex_frequency_domain<COMPACT_POSITIVE>      compact_positive_vertex_frequency_domain_type;
typedef vertex_frequency_domain<EXTENDED_POSITIVE>     extended_positive_vertex_frequency_domain_type;
typedef vertex_frequency_domain<COMPACT_SORTED>        compact_sorted_vertex_frequency_domain_type;
typedef vertex_frequency_domain<EXTENDED_SORTED>       extended_sorted_vertex_frequency_domain_type;
typedef vertex_frequency_domain<EXTENDED_BOSONIC>      bosonic_vertex_frequency_domain_type;
typedef vertex_frequency_domain<EXTENDED_FERMIONIC>    fermionic_vertex_frequency_domain_type;
typedef vertex_frequency_domain<CORE_SORTED>           vertex_frequency_domain_core_sorted_type;
typedef vertex_frequency_domain<HIGH_FREQUENCY_SORTED> vertex_frequency_domain_high_frequency_sorted_type;
...
static const int MAX_MEASURED_DIAGRAM_ORDER = 5000;
