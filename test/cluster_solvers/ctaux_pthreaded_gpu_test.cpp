...
// GPU version.
// Usage: ./ctaux_pthreaded_gpu_test inputFileName
//
...
int main(int argc, char *argv[]) {
  ...
  using ED_solver_type =
      cluster_solver<ADVANCED_ED_CLUSTER_SOLVER, LIN_ALG::GPU, parameters_type,
                     MOMS_type>;
  using posix_QMC_solver_type =
      posix_qmci_integrator<cluster_solver<CT_AUX_CLUSTER_SOLVER, LIN_ALG::GPU,
