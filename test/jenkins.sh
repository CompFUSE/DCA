...
# The first input argument is the name of the branch to build.
# The script requires curl.
#
# Usage: ./jenkins.sh branch-to-build

if [ $# -eq 0 ]; then
    printf "No branch name provided.\nUsage: ./jenkins.sh branch-to-build\n"
else
    printf "Triggering build of branch %s.\n" "$1"
