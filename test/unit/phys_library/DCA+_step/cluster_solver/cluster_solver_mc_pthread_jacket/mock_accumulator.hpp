...
//
// Description: Mock MC accumulator for the posix test. Checks that a valid state is passed before accumulation.
...
public:
  ...
  void measure();
  void sum_to(MockAccumulator& other) {
    other.n_measurments += n_measurments;
  }
