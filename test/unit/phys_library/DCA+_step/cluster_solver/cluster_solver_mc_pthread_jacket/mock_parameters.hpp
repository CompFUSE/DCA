...
public:
  ...
  ~MockParameters();
  int get_nr_walkers() { return nr_walkers; }
  int get_nr_accumulators() { return nr_accumulators; }
  int get_number_of_measurements() { return 10; }
  int get_warm_up_sweeps() { return 1; }
  int get_additional_steps() { return 1; }
...
MockParameters::MockParameters(int n_w, int n_a) :
        concurrency_obj(1, NULL),
        nr_walkers(n_w),nr_accumulators(n_a)
{
