...
/** \file
 *  This file tests the specialization of material_lattice three band Emery mode; on test for a
 *  CuO2 like system.
 */
...
struct CuO2EmeryStruct {
  static constexpr phys::models::Material type = phys::models::Material::CuO2_Emery;
};
...
template <typename T>
class MaterialLatticeCuO2EmeryTest : public ::testing::Test {};

using CuO2EmeryTypes = ::testing::Types<dca::testing::CuO2EmeryStruct>;
TYPED_TEST_CASE(MaterialLatticeCuO2EmeryTest, CuO2EmeryTypes);

TYPED_TEST(MaterialLatticeCuO2EmeryTest, Initialize_H_0) {
  using namespace dca;

  using Lattice = phys::models::material_lattice<TypeParam::type, phys::domains::no_symmetry<2>>;
...
TYPED_TEST(MaterialLatticeCuO2EmeryTest, Initialize_H_interaction) {
  using namespace dca;
