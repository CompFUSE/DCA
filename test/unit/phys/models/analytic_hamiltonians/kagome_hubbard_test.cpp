...
TEST(KagomeLatticeTest, Initialize_H_0) {
  // I think its actually D6.
  using PointGroup = phys::domains::no_symmetry<2>;
  using Lattice = phys::models::KagomeHubbard<PointGroup>;

  using BandDmn = func::dmn<3, int>;
...
TEST(KagomeLatticeTest, Initialize_H_interaction) {
  // I think its actually D6.
  using PointGroup = phys::domains::no_symmetry<2>;
  using Lattice = phys::models::KagomeHubbard<PointGroup>;

  using BandDmn = func::dmn_0<func::dmn<3, int>>;
