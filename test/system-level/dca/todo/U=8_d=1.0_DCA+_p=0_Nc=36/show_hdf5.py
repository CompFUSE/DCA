...
for l in [1]:
    ...
    file_name = "./T=0.15/data.DCA+_sp.hdf5"
    print(file_name)
               ...
               #         print iK, "  kx = ",Kx[iK],"ky = ",Ky[iK]
                ...
                if(function_name == "Self_Energy-stddev"):
                    ...
                    for pp in range(240, 272):
                        ...
                        value = data_function["data"][pp, 18, 0, 0, 0, 0, 1]

                        print data["domains"]["frequency-domain"]["elements"][pp], "  ", data["functions"]["Self_Energy"]["data"][pp, 18, 0, 0, 0, 0, 1], "  ", value
                    print("\t-----------------------------------------")
