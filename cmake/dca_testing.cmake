...
function(dca_add_gtest name)
  ...
  if (DCA_ADD_GTEST_CUDA AND NOT (DCA_HAVE_CUDA OR DCA_HAVE_HIP))
    return()
  endif()
  ...
  if (DCA_HAVE_HIP)
    set_property(TARGET ${name} PROPERTY CMAKE_HIP_ARCHITECTURES gfx906 gfx908)
    ...
    set_target_properties(${name} PROPERTIES POSITION_INDEPENDENT_CODE ON)
    target_link_libraries(${name} PUBLIC hip::host gpu_utils)
  endif()
  ...
  if (DCA_ADD_GTEST_CUDA OR DCA_ADD_GTEST_CUDA_MPI)
    ...
    ENDIF()
    IF(DCA_HAVE_HIP)
      target_compile_definitions(${name} PRIVATE DCA_HAVE_HIP)
      target_link_libraries(${name} PRIVATE roc::hipblas roc::hipsparse)
    ENDIF()
    if(DCA_HAVE_MAGMA)
