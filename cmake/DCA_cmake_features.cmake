#------------------------------------------------------------------------------
# (pretty) Print a list with a title and the list length
#------------------------------------------------------------------------------
...
#------------------------------------------------------------------------------
# Remove all items that appear in list1 from list2
#------------------------------------------------------------------------------
...
#------------------------------------------------------------------------------
# Check if all user supplied features are supported
# In : list of variable length num params
#------------------------------------------------------------------------------
function(DCA_check_cxx_features)
  ...
  # Get all CXX supported by the compiler
