...
set_property(CACHE DCA_LATTICE PROPERTY STRINGS bilayer square triangular Kagome hund twoband_Cu threeband
             FeAs material_NiO material_FeSn material_CuO2_Emergy)
...
elseif (DCA_LATTICE STREQUAL "material_CuO2_Emery")
  set(DCA_LATTICE_TYPE "dca::phys::models::material_lattice<dca::phys::models::Material::Emery, dca::phys::domains::${DCA_POINT_GROUP}>")
  set(DCA_LATTICE_INCLUDE
      "dca/phys/models/material_hamiltonians/material_lattice.hpp")
  set(DCA_MODEL_IS_MATERIAL_LATTICE ON CACHE BOOL "is the model a material lattice")
else()
  message(FATAL_ERROR "Please set DCA_LATTICE to a valid option: bilayer | square | triangular | Kagome | hund | twoband_Cu | threeband | FeAs | material_NiO | material_FeSn. | material_CuO2_Emergy")
endif()
