...
#ifndef VASP_BRILLOUIN_ZONE_CUT_DOMAIN_H
#define VASP_BRILLOUIN_ZONE_CUT_DOMAIN_H

namespace DFT
{
  namespace VASP
  {
    enum brillouin_zone_names {NO_NAME,
    ...
    public:
      ...
      typedef cluster_specifications<double, VASP_LATTICE, MOMENTUM_SPACE, PARALLELLEPIPEDUM>::dmn_specifications_type dmn_specifications_type;
