...
#include "type_definitions.h"
  ...
  public:
    ...
    static void execute(function<scalartype_1, dmn_8<b,b,b,b,k_DCA,k_DCA,w_VERTEX,w_VERTEX> >&                  G4,
			function<scalartype_2, dmn_2< dmn_4<b,b,k_DCA,w_VERTEX>, dmn_4<b,b,k_DCA,w_VERTEX> > >& G4_matrix)
    {
