...
#ifndef PHYS_LIBRARY_DOMAINS_TIME_AND_FREQUENCY_FREQUENCY_DOMAIN_COMPACT_H
#define PHYS_LIBRARY_DOMAINS_TIME_AND_FREQUENCY_FREQUENCY_DOMAIN_COMPACT_H
...
template <VERTEX_FREQUENCY_NAME NAME>
std::vector<typename vertex_frequency_domain<NAME>::element_type>& vertex_frequency_domain<
    NAME>::get_elements() {
...
#endif  // PHYS_LIBRARY_DOMAINS_TIME_AND_FREQUENCY_FREQUENCY_DOMAIN_COMPACT_H
