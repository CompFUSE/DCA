...
#ifndef PHYS_LIBRARY_DOMAINS_TIME_AND_FREQUENCY_TIME_DOMAIN_LEFT_ORIENTED_H
#define PHYS_LIBRARY_DOMAINS_TIME_AND_FREQUENCY_TIME_DOMAIN_LEFT_ORIENTED_H
...
#endif  // PHYS_LIBRARY_DOMAINS_TIME_AND_FREQUENCY_TIME_DOMAIN_LEFT_ORIENTED_H
