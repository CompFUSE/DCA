...
#ifndef PHYS_LIBRARY_DOMAINS_QUANTUM_DOMAIN_BRILLOUIN_ZONE_CUT_BZC_FERMI_SURFACE_SQUARE_2D_LATTICE_H
#define PHYS_LIBRARY_DOMAINS_QUANTUM_DOMAIN_BRILLOUIN_ZONE_CUT_BZC_FERMI_SURFACE_SQUARE_2D_LATTICE_H
...
std::vector<std::vector<double>>& brillouin_zone_path_domain<
    FERMI_SURFACE_SQUARE_2D_LATTICE>::get_elements() {
...
#endif  // PHYS_LIBRARY_DOMAINS_QUANTUM_DOMAIN_BRILLOUIN_ZONE_CUT_BZC_FERMI_SURFACE_SQUARE_2D_LATTICE_H
