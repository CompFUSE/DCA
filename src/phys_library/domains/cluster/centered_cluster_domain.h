...
#ifndef PHYS_LIBRARY_DOMAINS_CLUSTER_CENTERED_CLUSTER_DOMAIN_H
#define PHYS_LIBRARY_DOMAINS_CLUSTER_CENTERED_CLUSTER_DOMAIN_H
...
#endif  // PHYS_LIBRARY_DOMAINS_CLUSTER_CENTERED_CLUSTER_DOMAIN_H
