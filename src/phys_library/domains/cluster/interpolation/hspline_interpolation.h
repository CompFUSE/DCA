...
struct hspline_interpolation_generic {
  ...
  static void execute(FUNC_LIB::function<scalartype_input, domain_input>& f_input,
    ...
    hspline_interpolation_any_2_any<type_input, type_output, IndexOf<type_input, type_list1>::value +
                                                                 dmn_shift>::execute(f_input,
                                                                                     f_output, a);
  }
};
...
struct hspline_interpolation_generic<type_list1, type_list2, type_input, type_output, dmn_shift, -1> {
  ...
  static void execute(FUNC_LIB::function<scalartype_1, dmn_type_1>& /*f_source*/,
                      FUNC_LIB::function<scalartype_2, dmn_type_2>& /*F_target*/, double /*a*/) {}
};
...
public:
  ...
  static void execute(FUNC_LIB::function<scalartype_input, domain_input>& f_input,
    ...
    hspline_interpolation_generic<type_list_input, type_list_output, source_dmn_type, target_dmn_type, 0,
                                  IndexOf<source_dmn_type, type_list_input>::value>::execute(f_input,
                                                                                             f_output,
                                                                                             a);
  }
};
