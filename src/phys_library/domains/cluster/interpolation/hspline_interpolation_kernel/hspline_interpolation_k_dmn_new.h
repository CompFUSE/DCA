...
#ifndef HERMITE_SPLINE_INTERPOLATION_KERNEL_K_DMN_NEW_H
#define HERMITE_SPLINE_INTERPOLATION_KERNEL_K_DMN_NEW_H
...
class hspline_interpolation_kernel<scalartype, cluster_domain<scalar_type, D, N, MOMENTUM_SPACE, S>, target_k_dmn_t> 
{
...
template<typename scalartype, typename scalar_type, int D, CLUSTER_NAMES N, CLUSTER_SHAPE S, typename target_k_dmn_t>
hspline_interpolation_kernel<scalartype, cluster_domain<scalar_type, D, N, MOMENTUM_SPACE, S>, target_k_dmn_t>::hspline_interpolation_kernel():
  a(-0.5),
...
template<typename scalartype, typename scalar_type, int D, CLUSTER_NAMES N, CLUSTER_SHAPE S, typename target_k_dmn_t>
hspline_interpolation_kernel<scalartype, cluster_domain<scalar_type, D, N, MOMENTUM_SPACE, S>, target_k_dmn_t>::hspline_interpolation_kernel(double A):
  a(A),
...
template<typename scalartype, typename scalar_type, int D, CLUSTER_NAMES N, CLUSTER_SHAPE S, typename target_k_dmn_t>
void hspline_interpolation_kernel<scalartype, cluster_domain<scalar_type, D, N, MOMENTUM_SPACE, S>, target_k_dmn_t>::resize_k0_indices()
{
  int n = 1;
...
template<typename scalartype, typename scalar_type, int D, CLUSTER_NAMES N, CLUSTER_SHAPE S, typename target_k_dmn_t>
void hspline_interpolation_kernel<scalartype, cluster_domain<scalar_type, D, N, MOMENTUM_SPACE, S>, target_k_dmn_t>::delete_data_structures()
{
...
template<typename scalartype, typename scalar_type, int D, CLUSTER_NAMES N, CLUSTER_SHAPE S, typename target_k_dmn_t>
void hspline_interpolation_kernel<scalartype, cluster_domain<scalar_type, D, N, MOMENTUM_SPACE, S>, target_k_dmn_t>::allocate_data_structures()
{
  N_s = k_cluster_type::get_size();
  N_k = target_k_dmn_t::get_size();
...
template<typename scalartype, typename scalar_type, int D, CLUSTER_NAMES N, CLUSTER_SHAPE S, typename target_k_dmn_t>
void hspline_interpolation_kernel<scalartype, cluster_domain<scalar_type, D, N, MOMENTUM_SPACE, S>, target_k_dmn_t>::reset()
{
...
template<typename scalartype, typename scalar_type, int D, CLUSTER_NAMES N, CLUSTER_SHAPE S, typename target_k_dmn_t>
scalartype* hspline_interpolation_kernel<scalartype, cluster_domain<scalar_type, D, N, MOMENTUM_SPACE, S>, target_k_dmn_t>::get_interpolation_matrix()
{
  return interpolation_matrix;
}

template<typename scalartype, typename scalar_type, int D, CLUSTER_NAMES N, CLUSTER_SHAPE S, typename target_k_dmn_t>
void hspline_interpolation_kernel<scalartype, cluster_domain<scalar_type, D, N, MOMENTUM_SPACE, S>, target_k_dmn_t>::execute(scalartype* input, 
															     scalartype* output)
{
...
template<typename scalartype, typename scalar_type, int D, CLUSTER_NAMES N, CLUSTER_SHAPE S, typename target_k_dmn_t>
void hspline_interpolation_kernel<scalartype, cluster_domain<scalar_type, D, N, MOMENTUM_SPACE, S>, target_k_dmn_t>::execute_on_transpose(scalartype* input, scalartype* output, int n)
{
...
template<typename scalartype, typename scalar_type, int D, CLUSTER_NAMES N, CLUSTER_SHAPE S, typename target_k_dmn_t>
void hspline_interpolation_kernel<scalartype, cluster_domain<scalar_type, D, N, MOMENTUM_SPACE, S>, target_k_dmn_t>::set_dense_interpolation_matrix()
{
...
template<typename scalartype, typename scalar_type, int D, CLUSTER_NAMES N, CLUSTER_SHAPE S, typename target_k_dmn_t>
void hspline_interpolation_kernel<scalartype, cluster_domain<scalar_type, D, N, MOMENTUM_SPACE, S>, target_k_dmn_t>::get_dense_interpolation_matrix(std::vector<int>& col_index, 
																		    scalartype*&      I_ptr)
{
...
template<typename scalartype, typename scalar_type, int D, CLUSTER_NAMES N, CLUSTER_SHAPE S, typename target_k_dmn_t>
void hspline_interpolation_kernel<scalartype, cluster_domain<scalar_type, D, N, MOMENTUM_SPACE, S>, target_k_dmn_t>::find_neighbours()
{
  neighbours.resize(0);
...
template<typename scalartype, typename scalar_type, int D, CLUSTER_NAMES N, CLUSTER_SHAPE S, typename target_k_dmn_t>
void hspline_interpolation_kernel<scalartype, cluster_domain<scalar_type, D, N, MOMENTUM_SPACE, S>, target_k_dmn_t>::find_basis()
{
...
template<typename scalartype, typename scalar_type, int D, CLUSTER_NAMES N, CLUSTER_SHAPE S, typename target_k_dmn_t>
void hspline_interpolation_kernel<scalartype, cluster_domain<scalar_type, D, N, MOMENTUM_SPACE, S>, target_k_dmn_t>::find_super_basis()
{
  for(int d0=0; d0<DIMENSION; ++d0)
    for(int d1=0; d1<DIMENSION; ++d1)
...
template<typename scalartype, typename scalar_type, int D, CLUSTER_NAMES N, CLUSTER_SHAPE S, typename target_k_dmn_t>
void hspline_interpolation_kernel<scalartype, cluster_domain<scalar_type, D, N, MOMENTUM_SPACE, S>, target_k_dmn_t>::find_k_vecs()
{
...
template<typename scalartype, typename scalar_type, int D, CLUSTER_NAMES N, CLUSTER_SHAPE S, typename target_k_dmn_t>
void hspline_interpolation_kernel<scalartype, cluster_domain<scalar_type, D, N, MOMENTUM_SPACE, S>, target_k_dmn_t>::find_k_indices()
{
...
template<typename scalartype, typename scalar_type, int D, CLUSTER_NAMES N, CLUSTER_SHAPE S, typename target_k_dmn_t>
inline double hspline_interpolation_kernel<scalartype, cluster_domain<scalar_type, D, N, MOMENTUM_SPACE, S>, target_k_dmn_t>::volume(double* b0, double* b1)
{
  return (b0[0]*b1[1]-b0[1]*b1[0]);
}

template<typename scalartype, typename scalar_type, int D, CLUSTER_NAMES N, CLUSTER_SHAPE S, typename target_k_dmn_t>
inline double hspline_interpolation_kernel<scalartype, cluster_domain<scalar_type, D, N, MOMENTUM_SPACE, S>, target_k_dmn_t>::volume(double* b0, double* b1, double* b2)
{
  return (-b0[2]*b1[1]*b2[0] + b0[1]*b1[2]*b2[0] + b0[2]*b1[0]*b2[1] - b0[0]*b1[2]*b2[1] - b0[1]*b1[0]*b2[2] + b0[0]*b1[1]*b2[2]);
}

template<typename scalartype, typename scalar_type, int D, CLUSTER_NAMES N, CLUSTER_SHAPE S, typename target_k_dmn_t>
inline void hspline_interpolation_kernel<scalartype, cluster_domain<scalar_type, D, N, MOMENTUM_SPACE, S>, target_k_dmn_t>::coordinates(double* b0, double* b1, 
																	double* r, double* x)
{
...
template<typename scalartype, typename scalar_type, int D, CLUSTER_NAMES N, CLUSTER_SHAPE S, typename target_k_dmn_t>
inline void hspline_interpolation_kernel<scalartype, cluster_domain<scalar_type, D, N, MOMENTUM_SPACE, S>, target_k_dmn_t>::coordinates(double* b0, double* b1, double* b2, 
																	double* r, double* x)
{
...
template<typename scalartype, typename scalar_type, int D, CLUSTER_NAMES N, CLUSTER_SHAPE S, typename target_k_dmn_t>
inline double hspline_interpolation_kernel<scalartype, cluster_domain<scalar_type, D, N, MOMENTUM_SPACE, S>, target_k_dmn_t>::evaluate_hermite_kernel_at(std::vector<double>& k_vec)
{
...
template<typename scalartype, typename scalar_type, int D, CLUSTER_NAMES N, CLUSTER_SHAPE S, typename target_k_dmn_t>
inline void  hspline_interpolation_kernel<scalartype, cluster_domain<scalar_type, D, N, MOMENTUM_SPACE, S>, target_k_dmn_t>::generate_k0_indices(std::vector<double> k_vec)
{
...
template<typename scalartype, typename scalar_type, int D, CLUSTER_NAMES N, CLUSTER_SHAPE S, typename target_k_dmn_t>
void hspline_interpolation_kernel<scalartype, cluster_domain<scalar_type, D, N, MOMENTUM_SPACE, S>, target_k_dmn_t>::construct_interpolation_matrix_fast()
{
  typedef extended_k_domain<source_k_dmn_t> extended_k_dmn_t;
