...
//   typedef centered_r_LDA      this_type;
...
template<typename source_base_cluster_type, typename target_dmn_type>
wannier_interpolation_kernel<k_cluster<FULL, source_base_cluster_type>, target_dmn_type>::wannier_interpolation_kernel():
  //grid_size(LDA_cluster_type::grid_size()),
  //grid_size(k_LDA::parameter_type::grid_size()),
...
template<typename source_base_cluster_type, typename target_dmn_type>
void wannier_interpolation_kernel<k_cluster<FULL, source_base_cluster_type>, target_dmn_type>::check_grid_sizes()
{
  int size = 1;
  for(int i=0; i<DIMENSION; ++i)
    size *= grid_size[i];
...
template<typename source_base_cluster_type, typename target_dmn_type>
std::complex<double>& wannier_interpolation_kernel<k_cluster<FULL, source_base_cluster_type>, target_dmn_type>::get_F_r(int i)
{
  return F_R(i);
}

template<typename source_base_cluster_type, typename target_dmn_type>
void wannier_interpolation_kernel<k_cluster<FULL, source_base_cluster_type>, target_dmn_type>::reset_input()
{
  nfft_finalize(&nfft_K_2_R);
  initialize_nfft_K_2_R();
}
...
template<typename source_base_cluster_type, typename target_dmn_type>
void wannier_interpolation_kernel<k_cluster<FULL, source_base_cluster_type>, target_dmn_type>::reset_output()
{
  nfft_finalize(&nfft_R_2_k);
  initialize_nfft_R_2_k();
}
...
template<typename source_base_cluster_type, typename target_dmn_type>
void wannier_interpolation_kernel<k_cluster<FULL, source_base_cluster_type>, target_dmn_type>::execute(std::complex<double>* input_ptr,
												       std::complex<double>* output_ptr)
{
...
template<typename source_base_cluster_type, typename target_dmn_type>
void wannier_interpolation_kernel<k_cluster<FULL, source_base_cluster_type>, target_dmn_type>::set(std::complex<double>* input_ptr)
{
  FT_F_K__to__F_R(input_ptr);
}

template<typename source_base_cluster_type, typename target_dmn_type>
void wannier_interpolation_kernel<k_cluster<FULL, source_base_cluster_type>, target_dmn_type>::get(std::complex<double>* output_ptr)
{
  FT_F_R__to__F_k(output_ptr);
}

template<typename source_base_cluster_type, typename target_dmn_type>
void wannier_interpolation_kernel<k_cluster<FULL, source_base_cluster_type>, target_dmn_type>::initialize_nfft_K_2_R()
{
...
template<typename source_base_cluster_type, typename target_dmn_type>
void wannier_interpolation_kernel<k_cluster<FULL, source_base_cluster_type>, target_dmn_type>::initialize_nfft_R_2_k()
{
...
template<typename source_base_cluster_type, typename target_dmn_type>
void wannier_interpolation_kernel<k_cluster<FULL, source_base_cluster_type>, target_dmn_type>::FT_F_K__to__F_R(std::complex<double>* input_ptr)
{
...
template<typename source_base_cluster_type, typename target_dmn_type>
void wannier_interpolation_kernel<k_cluster<FULL, source_base_cluster_type>, target_dmn_type>::FT_F_R__to__F_k(std::complex<double>* output_ptr)
{
  for(int r_ind=0; r_ind<centered_r_cluster_dmn_t::dmn_size(); r_ind++){
 ...
 */
template<typename source_base_cluster_type, typename target_dmn_type>
void wannier_interpolation_kernel<k_cluster<FULL, source_base_cluster_type>, target_dmn_type>::initialize_centered_r_cluster()
{
...
template<typename source_base_cluster_type, typename target_dmn_type>
void wannier_interpolation_kernel<k_cluster<FULL, source_base_cluster_type>, target_dmn_type>::initialize_cut_off()
{
