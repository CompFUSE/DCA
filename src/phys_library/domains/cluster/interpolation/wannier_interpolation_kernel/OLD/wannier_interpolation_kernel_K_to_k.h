...
#ifndef WANNIER_INTERPOLATION_KERNEL_K_TO_k_H
#define WANNIER_INTERPOLATION_KERNEL_K_TO_k_H

/*! \class   wannier_interpolation_kernel
 *  \ingroup INTERPOLATION
 *
 *  \author  Peter Staar
 *  \brief   This class implements a Wannier interpolation technique, using the BLAS gemv call.
 */
...
wannier_interpolation_kernel<k_cluster<FULL, source_base_cluster_type>, target_dmn_type>::wannier_interpolation_kernel():
  ...
  gemv_pln(target_k_dmn_t::dmn_size(), source_k_dmn_t::dmn_size())
{
  find_phase_factors();
...
template<typename source_base_cluster_type, typename target_dmn_type>
void wannier_interpolation_kernel<k_cluster<FULL, source_base_cluster_type>, target_dmn_type>::reset_kernel()
{
  kernel.reset();
...
template<typename source_base_cluster_type, typename target_dmn_type>
void wannier_interpolation_kernel<k_cluster<FULL, source_base_cluster_type>, target_dmn_type>::find_phase_factors(bool REDO_INITIALIZE)
{
  {
