...
#ifndef CUPRATE_SINGLE_BAND_MODEL_PARAMETERS_H
#define CUPRATE_SINGLE_BAND_MODEL_PARAMETERS_H

/*!
 *  \author: peter staar
 */
template<typename dca_point_group_t>
class model_parameters<cuprate_single_band_model<dca_point_group_t> >
{
...
template<typename dca_point_group_t>
model_parameters<cuprate_single_band_model<dca_point_group_t> >::model_parameters():
  U_dd(0),
...
template<typename dca_point_group_t>
template<class concurrency_type>
int model_parameters<cuprate_single_band_model<dca_point_group_t> >::get_buffer_size(const concurrency_type& concurrency) const
{
  int buffer_size = 0;
...
template<typename dca_point_group_t>
template<class concurrency_type>
void model_parameters<cuprate_single_band_model<dca_point_group_t> >::pack(const concurrency_type& concurrency, int* buffer, int buffer_size, int& position)
{
...
template<typename dca_point_group_t>
template<class concurrency_type>
void model_parameters<cuprate_single_band_model<dca_point_group_t> >::unpack(const concurrency_type& concurrency, int* buffer, int buffer_size, int& position)
{
...
template<typename dca_point_group_t>
template<class stream_type>
void model_parameters<cuprate_single_band_model<dca_point_group_t> >::to_JSON(stream_type& ss, bool is_end)
{
  ss << "\"model-parameters\" :";
  ss << "\n{ \n";
  ...
  JSON_writer::write(ss, "compound-file-name" , compound_file_name);
...
template<typename dca_point_group_t>
template<class JSON_reader_type>
void model_parameters<cuprate_single_band_model<dca_point_group_t> >::from_JSON(JSON_reader_type& reader)
{
...
template<typename dca_point_group_t>
double model_parameters<cuprate_single_band_model<dca_point_group_t> >::get_U_dd()
{
  return U_dd;
}

template<typename dca_point_group_t>
std::string model_parameters<cuprate_single_band_model<dca_point_group_t> >::get_compound_file_name()
{
  return compound_file_name;
}

template<typename dca_point_group_t>
std::vector<int>& model_parameters<cuprate_single_band_model<dca_point_group_t> >::get_H_k_grid_size()
{
