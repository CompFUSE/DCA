...
template<class concurrency_type>
void MC_solver_parameters<PCM> ::pack(const concurrency_type& concurrency, int* buffer, int buffer_size, int& position)
{
...
template<class concurrency_type>
void MC_solver_parameters<PCM> ::unpack(const concurrency_type& concurrency, int* buffer, int buffer_size, int& position)
{
...
template<typename scalartype>
std::vector<scalartype> MC_solver_parameters<PCM>::linearize(const std::vector<std::vector<scalartype> >& vec) const
{
...
template<typename scalartype>
void MC_solver_parameters<PCM>::un_linearize(int                                    dimension,
					     std::vector<scalartype>&		    vec_lin,
					     std::vector<std::vector<scalartype> >& vec)
{
