...
#ifndef FILE_NAMES_PARAMETERS_H
#define FILE_NAMES_PARAMETERS_H
...
template<class concurrency_type>
void file_names_parameters::pack( concurrency_type& concurrency, int* buffer, int buffer_size, int& position)
{
...
template<class concurrency_type>
void file_names_parameters::unpack( concurrency_type& concurrency, int* buffer, int buffer_size, int& position)
{
  ...
  try
    {
      ...
      try { read_write_obj.execute("directory", directory_filename);                    } catch(const std::exception& r_e) {}

      try { read_write_obj.execute("output-file", output_filename);                     } catch(const std::exception& r_e) {}

      try { read_write_obj.execute("profiling-file", profiling_filename);               } catch(const std::exception& r_e) {}

      try { read_write_obj.execute("spectrum-file", spectrum_filename);                 } catch(const std::exception& r_e) {}

      try { read_write_obj.execute("susceptibilities-file", susceptibilities_filename); } catch(const std::exception& r_e) {}

      try { read_write_obj.execute("plot-vertex-file", vertex_filename);                } catch(const std::exception& r_e) {}

      try { read_write_obj.execute("output-format", format_str);                        } catch(const std::exception& r_e) {}

      try { read_write_obj.execute("output-ED" , ED_output_file);                       } catch(const std::exception& r_e) {}
      try { read_write_obj.execute("output-CPE", CPE_output_file);                      } catch(const std::exception& r_e) {}
      try { read_write_obj.execute("output-QMC", QMC_output_file);                      } catch(const std::exception& r_e) {}

      try { read_write_obj.execute("dump-lattice-self-energy"    , dump_lattice_Self_energy_str     ); } catch(const std::exception& r_e) {}
      try { read_write_obj.execute("dump-cluster-Greens-function", dump_cluster_Greens_functions_str); } catch(const std::exception& r_e) {}
