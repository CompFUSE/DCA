...
//
// This class contains all parameters for the ED solver.

#ifndef PHYS_LIBRARY_PARAMETERS_PARAMETERS_SPECIALIZATION_TEMPLATES_ED_SOLVER_PARAMETERS_H
#define PHYS_LIBRARY_PARAMETERS_PARAMETERS_SPECIALIZATION_TEMPLATES_ED_SOLVER_PARAMETERS_H
...
template <class concurrency_type>
void ED_solver_parameters::pack(concurrency_type& concurrency, int* buffer, int buffer_size,
                                int& position) {
...
template <class concurrency_type>
void ED_solver_parameters::unpack(concurrency_type& concurrency, int* buffer, int buffer_size,
                                  int& position) {
...
void ED_solver_parameters::read_write(read_write_type& read_write_obj) {
  try {
    ...
    try {
      read_write_obj.execute("eigenvalue-cut-off", eigenvalue_cut_off);
    }
    catch (const std::exception& r_e) {
    }

    try {
      read_write_obj.execute("check_orthogonality_of_states", check_orthogonality_of_states);
    }
    catch (const std::exception& r_e) {
    }

    try {
      read_write_obj.execute("symmetries", symmetries);
    }
    catch (const std::exception& r_e) {
    }

    try {
      read_write_obj.execute("ED_method", ED_method);
    }
    catch (const std::exception& r_e) {
    }

    try {
      read_write_obj.execute("check_sector", check_sector);
    }
    catch (const std::exception& r_e) {
    }

    try {
      read_write_obj.execute("occupation", occupation);
    }
    catch (const std::exception& r_e) {
    }

    try {
      read_write_obj.execute("magnetization", magnetization);
    }
    catch (const std::exception& r_e) {
    }

    try {
      read_write_obj.execute("n_0", n_0);
    }
    catch (const std::exception& r_e) {
    }
    try {
      read_write_obj.execute("Sz_0", Sz_0);
    }
    catch (const std::exception& r_e) {
    }
    try {
      read_write_obj.execute("n_1", n_1);
    }
    catch (const std::exception& r_e) {
    }
    try {
      read_write_obj.execute("Sz_1", Sz_1);
    }
    catch (const std::exception& r_e) {
    }
    try {
      read_write_obj.execute("nu", nu);
    }
    catch (const std::exception& r_e) {
    }
...
#endif  // PHYS_LIBRARY_PARAMETERS_PARAMETERS_SPECIALIZATION_TEMPLATES_ED_SOLVER_PARAMETERS_H
