...
template<class concurrency_t, class model_t, DCA::CLUSTER_SOLVER_NAMES CLUSTER_SOLVER_NAME>
void Parameters<concurrency_t, model_t, CLUSTER_SOLVER_NAME>::read_input_and_broadcast(std::string filename)
{
...
template<class concurrency_t, class model_t, DCA::CLUSTER_SOLVER_NAMES CLUSTER_SOLVER_NAME>
void Parameters<concurrency_t, model_t, CLUSTER_SOLVER_NAME>::pack( concurrency_t& concurrency, int* buffer, int buffer_size, int& position)
{
...
template<class concurrency_t, class model_t, DCA::CLUSTER_SOLVER_NAMES CLUSTER_SOLVER_NAME>
void Parameters<concurrency_t, model_t, CLUSTER_SOLVER_NAME>::unpack( concurrency_t& concurrency, int* buffer, int buffer_size, int& position)
{
...
template<class concurrency_t, class model_t, DCA::CLUSTER_SOLVER_NAMES CLUSTER_SOLVER_NAME>
std::string Parameters<concurrency_t, model_t, CLUSTER_SOLVER_NAME>::make_python_readable(std::string str)
{
  {
    std::string tmp("\n\n");
    while(true){
