...
//
// Author: Andrei Plamada (plamada@itp.phys.ethz.ch)
//
// Description

#ifndef PHYS_LIBRARY_PARAMETERS_MODELS_MATERIAL_HAMILTONIANS_TEMPLATE_SPECIALIZATION_CUO2_1BAND_MATERIAL_LATTICE_CUO2_1BAND_H
#define PHYS_LIBRARY_PARAMETERS_MODELS_MATERIAL_HAMILTONIANS_TEMPLATE_SPECIALIZATION_CUO2_1BAND_MATERIAL_LATTICE_CUO2_1BAND_H
...
std::vector<std::pair<std::pair<int, int>, std::pair<int, int>>> material_lattice<
    CuO2_1band, point_group_type>::get_orbital_permutations() {
...
template <typename point_group_type>
template <class domain, class parameters_type>
void material_lattice<CuO2_1band, point_group_type>::initialize_H_interaction(
...
template <typename point_group_type>
template <class domain>
void material_lattice<CuO2_1band, point_group_type>::initialize_H_symmetry(
...
template <typename point_group_type>
template <class parameters_type>
std::vector<std::vector<double>>& material_lattice<CuO2_1band, point_group_type>::get_t_ij(
    parameters_type& parameters) {
...
template <typename point_group_type>
template <class parameters_type>
std::complex<double> material_lattice<CuO2_1band, point_group_type>::get_LDA_Hamiltonians(
...
#endif  // PHYS_LIBRARY_PARAMETERS_MODELS_MATERIAL_HAMILTONIANS_TEMPLATE_SPECIALIZATION_CUO2_1BAND_MATERIAL_LATTICE_CUO2_1BAND_H
