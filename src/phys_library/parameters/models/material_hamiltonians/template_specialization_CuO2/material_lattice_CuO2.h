...
#ifndef PHYS_LIBRARY_PARAMETERS_MODELS_MATERIAL_HAMILTONIANS_TEMPLATE_SPECIALIZATION_CUO2_MATERIAL_LATTICE_CUO2_H
#define PHYS_LIBRARY_PARAMETERS_MODELS_MATERIAL_HAMILTONIANS_TEMPLATE_SPECIALIZATION_CUO2_MATERIAL_LATTICE_CUO2_H
...
std::vector<std::pair<std::pair<int, int>, std::pair<int, int>>> material_lattice<
    CuO2, point_group_type>::get_orbital_permutations() {
...
template <typename point_group_type>
template <class domain, class parameters_type>
void material_lattice<CuO2, point_group_type>::initialize_H_interaction(
...
template <typename point_group_type>
template <class domain>
void material_lattice<CuO2, point_group_type>::initialize_H_symmetry(
...
#endif  // PHYS_LIBRARY_PARAMETERS_MODELS_MATERIAL_HAMILTONIANS_TEMPLATE_SPECIALIZATION_CUO2_MATERIAL_LATTICE_CUO2_H
