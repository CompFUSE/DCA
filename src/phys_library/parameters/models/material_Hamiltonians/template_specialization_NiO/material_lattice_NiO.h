...
template<typename point_group_type>
std::vector<std::pair<std::pair<int,int>, std::pair<int,int> > > material_lattice<NiO_symmetric, point_group_type>::get_orbital_permutations()
{
...
template<typename point_group_type>
template<class domain, class parameters_type>
void material_lattice<NiO_symmetric, point_group_type>::initialize_H_interaction(FUNC_LIB::function<double , domain >& H_i,
                                                                       parameters_type&            parameters)
{
...
template<typename point_group_type>
template<class domain>
void material_lattice<NiO_symmetric, point_group_type>::initialize_H_symmetry(FUNC_LIB::function<int , domain>& H_symmetries)
{
    H_symmetries = -1;
...
template<typename point_group_type>
template<class parameters_type>
std::vector<std::vector<double> >& material_lattice<NiO_symmetric, point_group_type>::get_t_ij(parameters_type& parameters)
{
...
template<typename point_group_type>
template<class parameters_type>
std::complex<double> material_lattice<NiO_symmetric, point_group_type>::get_LDA_Hamiltonians(parameters_type& parameters,
                                                                                   std::vector<double> k,
...
template<typename point_group_type>
std::vector<std::pair<std::pair<int,int>, std::pair<int,int> > > material_lattice<NiO_unsymmetric, point_group_type>::get_orbital_permutations()
{
    static std::vector<std::pair<std::pair<int,int>, std::pair<int,int> > > permutations(0);
    return permutations;
}
...
template<typename point_group_type>
template<class domain, class parameters_type>
void material_lattice<NiO_unsymmetric, point_group_type>::initialize_H_interaction(FUNC_LIB::function<double , domain >& H_i,
                                                                       parameters_type&            parameters)
{
    std::vector<std::vector<double> > U;
...
template<typename point_group_type>
template<class domain>
void material_lattice<NiO_unsymmetric, point_group_type>::initialize_H_symmetry(FUNC_LIB::function<int , domain>& H_symmetries)
{
    H_symmetries = -1;
...
template<typename point_group_type>
template<class parameters_type>
std::vector<std::vector<double> >& material_lattice<NiO_unsymmetric, point_group_type>::get_t_ij(parameters_type& parameters)
{
    static std::vector<std::vector<double> > t_ij(0, std::vector<double>(0));
...
template<typename point_group_type>
template<class parameters_type>
std::complex<double> material_lattice<NiO_unsymmetric, point_group_type>::get_LDA_Hamiltonians(parameters_type& parameters,
                                                                                   std::vector<double> k,
                                                                                   int b1, int s1, int b2, int s2)
{
    const static std::complex<double> I(0,1);
