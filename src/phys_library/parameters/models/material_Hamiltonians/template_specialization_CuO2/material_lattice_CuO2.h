...
#ifndef MATERIAL_LATTICE_CUO2_H
#define MATERIAL_LATTICE_CUO2_H
...
template<typename point_group_type>
double* material_lattice<CuO2, point_group_type>::initialize_r_DCA_basis()
{
...
template<typename point_group_type>
double* material_lattice<CuO2, point_group_type>::initialize_r_LDA_basis()
{
  const static double a = 1.0;
...
template<typename point_group_type>
std::vector<int> material_lattice<CuO2, point_group_type>::get_flavors()
{
...
template<typename point_group_type>
std::vector<std::vector<double> > material_lattice<CuO2, point_group_type>::get_a_vectors()
{
...
template<typename point_group_type>
std::vector<std::pair<std::pair<int,int>, std::pair<int,int> > > material_lattice<CuO2, point_group_type>::get_orbital_permutations()
{
...
template<typename point_group_type>
template<class domain, class parameters_type>
void material_lattice<CuO2, point_group_type>::initialize_H_interaction(FUNC_LIB::function<double , domain >& H_i,
                                                                       parameters_type&            parameters)
{
...
template<typename point_group_type>
template<class domain>
void material_lattice<CuO2, point_group_type>::initialize_H_symmetry(FUNC_LIB::function<int , domain>& H_symmetries)
{
  H_symmetries = -1;
...
template<typename point_group_type>
template<class parameters_type>
std::vector<std::vector<double> >& material_lattice<CuO2, point_group_type>::get_t_ij(parameters_type& parameters)
{
...
template<typename point_group_type>
template<class parameters_type>
std::complex<double> material_lattice<CuO2, point_group_type>::get_LDA_Hamiltonians(parameters_type& parameters,
                                                                                   std::vector<double> k,
