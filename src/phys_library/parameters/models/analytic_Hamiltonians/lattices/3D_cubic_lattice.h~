...
template<typename point_group_type>
template<class domain, class parameters_type>
void cubic_lattice<point_group_type>::initialize_H_interaction(function<double , domain >& H_interaction,
                                                                parameters_type&            parameters)
{
...
template<typename point_group_type>
template<class domain>
void cubic_lattice<point_group_type>::initialize_H_symmetry(function<int , domain>& H_symmetries)
{
