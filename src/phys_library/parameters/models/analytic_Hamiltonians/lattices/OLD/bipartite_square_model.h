...
template<typename DCA_point_group_type>
template<class domain, class parameters_type>
void bipartite_square_model<DCA_point_group_type>::initialize_H_interaction(function<double , domain >& H_interaction,
									    parameters_type&            parameters)
{
...
template<typename DCA_point_group_type>
template<class domain>
void bipartite_square_model<DCA_point_group_type>::initialize_H_symmetry(function<int , domain>& H_symmetries)
{
  // e_up <==> e_dn symmetry
