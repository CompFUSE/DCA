...
template<typename DCA_point_group_type>
template<class domain, class parameters_type>
void Bett_cluster_square_2D_layered_non_interacting<DCA_point_group_type>::initialize_H_interaction(FUNC_LIB::function<double , domain >& H_interaction,
										    parameters_type&            parameters)
{
...
template<typename DCA_point_group_type>
template<class domain>
void Bett_cluster_square_2D_layered_non_interacting<DCA_point_group_type>::initialize_H_symmetry(FUNC_LIB::function<int , domain>& H_symmetries)
{
  // e_up <==> e_dn symmetry
