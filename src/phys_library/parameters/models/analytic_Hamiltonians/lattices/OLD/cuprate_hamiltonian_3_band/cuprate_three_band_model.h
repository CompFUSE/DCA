...
template<typename DCA_point_group_type>
template<class domain, class parameters_type>
void cuprate_three_band_model<DCA_point_group_type>::initialize_H_interaction(function<double , domain >& H_interaction,
									      parameters_type&            parameters)
{
  H_interaction = 0.;
...
template<typename DCA_point_group_type>
template<class domain>
void cuprate_three_band_model<DCA_point_group_type>::initialize_H_symmetries(function<int, domain>& H_symmetries)
{
  H_symmetries = -1;
...
template<typename DCA_point_group_type>
template<class domain, class parameters_type>
void cuprate_three_band_model<DCA_point_group_type>::initialize_H_LDA(function<std::complex<double>, domain>& H_LDA,
								    parameters_type&                        parameters)
{
