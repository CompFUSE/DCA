...
#ifndef CUPRATE_THREE_BAND_MODEL_H
#define CUPRATE_THREE_BAND_MODEL_H

/*!
 *  \author peter staar
 */
template<typename DCA_point_group_type>
class cuprate_three_band_model
{
public:
...
template<typename DCA_point_group_type>
std::vector<std::vector<double> > cuprate_three_band_model<DCA_point_group_type>::t_ij(0, std::vector<double>(0));

template<typename DCA_point_group_type>
double cuprate_three_band_model<DCA_point_group_type>::U_dd = 0;

template<typename DCA_point_group_type>
double cuprate_three_band_model<DCA_point_group_type>::U_pp = 0;

template<typename DCA_point_group_type>
template<class parameters_type>
void cuprate_three_band_model<DCA_point_group_type>::initialize(parameters_type& parameters)
{
  U_dd = parameters.get_U_dd();
  U_pp = parameters.get_U_pp();

  {
    ...
    if(fabs(U_pp)>1.e-3){
      ...
      parameters.get_interacting_bands().push_back(2);
    }
  }
...
template<typename DCA_point_group_type>
std::vector<int>& cuprate_three_band_model<DCA_point_group_type>::LDA_grid_size()
{
...
template<typename DCA_point_group_type>
double* cuprate_three_band_model<DCA_point_group_type>::get_r_DCA_basis()
{
...
template<typename DCA_point_group_type>
double* cuprate_three_band_model<DCA_point_group_type>::get_k_DCA_basis()
{
...
template<typename DCA_point_group_type>
double* cuprate_three_band_model<DCA_point_group_type>::get_r_LDA_basis()
{
...
template<typename DCA_point_group_type>
double* cuprate_three_band_model<DCA_point_group_type>::get_k_LDA_basis()
{
...
template<typename DCA_point_group_type>
double* cuprate_three_band_model<DCA_point_group_type>::initialize_r_DCA_basis()
{
...
template<typename DCA_point_group_type>
double* cuprate_three_band_model<DCA_point_group_type>::initialize_k_DCA_basis()
{
...
template<typename DCA_point_group_type>
double* cuprate_three_band_model<DCA_point_group_type>::initialize_r_LDA_basis()
{
...
template<typename DCA_point_group_type>
double* cuprate_three_band_model<DCA_point_group_type>::initialize_k_LDA_basis()
{
...
template<typename DCA_point_group_type>
std::vector<int> cuprate_three_band_model<DCA_point_group_type>::get_flavors()
{
...
template<typename DCA_point_group_type>
std::vector<std::vector<double> > cuprate_three_band_model<DCA_point_group_type>::get_a_vectors()
{
...
template<typename DCA_point_group_type>
std::vector<std::pair<std::pair<int,int>, std::pair<int,int> > > cuprate_three_band_model<DCA_point_group_type>::get_orbital_permutations()
{
...
template<typename DCA_point_group_type>
template<class domain, class parameters_type>
void cuprate_three_band_model<DCA_point_group_type>::initialize_H_interaction(FUNC_LIB::function<double , domain >& H_interaction,
									      parameters_type&            parameters)
{
  H_interaction = 0.;

  H_interaction(0,0,0,1,0) = U_dd;
  H_interaction(0,1,0,0,0) = U_dd;

  H_interaction(1,0,1,1,0) = U_pp;
  H_interaction(1,1,1,0,0) = U_pp;
  
  H_interaction(2,0,2,1,0) = U_pp;
  H_interaction(2,1,2,0,0) = U_pp;
}

template<typename DCA_point_group_type>
template<class domain>
void cuprate_three_band_model<DCA_point_group_type>::initialize_H_symmetries(FUNC_LIB::function<int, domain>& H_symmetries)
{
  H_symmetries = -1;
...
template<typename DCA_point_group_type>
template<class domain, class parameters_type>
void cuprate_three_band_model<DCA_point_group_type>::initialize_H_LDA(FUNC_LIB::function<std::complex<double>, domain>& H_LDA,
								    parameters_type&                        parameters)
{
...
template<typename DCA_point_group_type>
template<class parameters_type>
std::complex<double> cuprate_three_band_model<DCA_point_group_type>::get_LDA_Hamiltonians(parameters_type& parameters,
											  std::vector<double> k, 
