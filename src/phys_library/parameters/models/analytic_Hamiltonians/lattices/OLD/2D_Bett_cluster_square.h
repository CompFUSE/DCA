...
#ifndef BETT_CLUSTER_SQUARE_2D
#define BETT_CLUSTER_SQUARE_2D

/*!
 *  \author peter staar
 */
template<typename DCA_point_group_type>
class Bett_cluster_square_2D
{
public:
...
template<typename DCA_point_group_type>
double* Bett_cluster_square_2D<DCA_point_group_type>::initialize_r_DCA_basis()
{
...
template<typename DCA_point_group_type>
double* Bett_cluster_square_2D<DCA_point_group_type>::initialize_k_DCA_basis()
{
...
template<typename DCA_point_group_type>
double* Bett_cluster_square_2D<DCA_point_group_type>::initialize_r_LDA_basis()
{
...
template<typename DCA_point_group_type>
double* Bett_cluster_square_2D<DCA_point_group_type>::initialize_k_LDA_basis()
{
...
template<typename DCA_point_group_type>
std::vector<int> Bett_cluster_square_2D<DCA_point_group_type>::get_flavors()
{
...
template<typename DCA_point_group_type>
std::vector<std::vector<double> > Bett_cluster_square_2D<DCA_point_group_type>::get_a_vectors()
{
...
template<typename DCA_point_group_type>
std::vector<std::pair<std::pair<int,int>, std::pair<int,int> > > Bett_cluster_square_2D<DCA_point_group_type>::get_orbital_permutations()
{
...
template<typename DCA_point_group_type>
template<class domain, class parameters_type>
void Bett_cluster_square_2D<DCA_point_group_type>::initialize_H_interaction(FUNC_LIB::function<double , domain >& H_interaction,
									    parameters_type&            parameters)
{
...
template<typename DCA_point_group_type>
template<class domain>
void Bett_cluster_square_2D<DCA_point_group_type>::initialize_H_symmetry(FUNC_LIB::function<int , domain>& H_symmetries)
{
...
template<typename DCA_point_group_type>
template<class parameters_type>
std::complex<double> Bett_cluster_square_2D<DCA_point_group_type>::get_LDA_Hamiltonians(parameters_type& parameters,
											std::vector<double> k, 
