...
template<typename point_group_type>
template<class domain, class parameters_type>
void bilayer_lattice<point_group_type>::initialize_H_interaction(function<double , domain >& H_interaction,
                                                                 parameters_type&            parameters)
{
  H_interaction = 0.;
...
template<typename point_group_type>
template<class domain>
void bilayer_lattice<point_group_type>::initialize_H_symmetry(function<int, domain>& H_symmetries)
{
  H_symmetries = -1;
...
template<typename point_group_type>
template<class domain, class parameters_type>
void bilayer_lattice<point_group_type>::initialize_H_LDA(function<std::complex<double>, domain>& H_LDA,
                                                         parameters_type&                        parameters)
{
