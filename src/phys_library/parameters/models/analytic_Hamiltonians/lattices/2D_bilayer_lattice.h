...
// template<typename point_group_type>
// std::vector<int>& bilayer_lattice<point_group_type>::LDA_grid_size()
// {
...
// template<typename point_group_type>
// double* bilayer_lattice<point_group_type>::get_r_DCA_basis()
// {
...
// template<typename point_group_type>
// double* bilayer_lattice<point_group_type>::get_k_DCA_basis()
// {
...
// template<typename point_group_type>
// double* bilayer_lattice<point_group_type>::get_r_LDA_basis()
// {
...
// template<typename point_group_type>
// double* bilayer_lattice<point_group_type>::get_k_LDA_basis()
// {
...
template<typename point_group_type>
std::vector<std::pair<std::pair<int,int>, std::pair<int,int> > > bilayer_lattice<point_group_type>::get_orbital_permutations()
{
...
template<typename point_group_type>
template<class domain, class parameters_type>
void bilayer_lattice<point_group_type>::initialize_H_interaction(FUNC_LIB::function<double , domain >& H_interaction,
                                                                 parameters_type&            parameters)
{
  H_interaction = 0.;
...
template<typename point_group_type>
template<class domain>
void bilayer_lattice<point_group_type>::initialize_H_symmetry(FUNC_LIB::function<int, domain>& H_symmetries)
{
  H_symmetries = -1;
...
template<typename point_group_type>
template<class domain, class parameters_type>
void bilayer_lattice<point_group_type>::initialize_H_LDA(FUNC_LIB::function<std::complex<double>, domain>& H_LDA,
                                                         parameters_type&                        parameters)
{
...
template<typename point_group_type>
template<class parameters_type>
std::complex<double> bilayer_lattice<point_group_type>::get_LDA_Hamiltonians(parameters_type& parameters,
                                                                             std::vector<double> k,
