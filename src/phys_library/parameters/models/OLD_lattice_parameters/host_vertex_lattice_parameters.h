...
#ifndef HOST_VERTEX_LATTICE_PARAMETERS_H
#define HOST_VERTEX_LATTICE_PARAMETERS_H

/*!
 * \author peter staar
 */
template<class model>
class host_vertex_lattice_parameters 
{
public:
...
template<class model>
double*& host_vertex_lattice_parameters<model>::lattice_vectors()
{
...
template<class model>
double*& host_vertex_lattice_parameters<model>::reciprocal_lattice_vectors()
{
