...
namespace DCA
{
  namespace QMCI
  {
    ...
    class MC_walker<CT_AUX_SOLVER, device_t, parameters_type, MOMS_type> : public MC_walker_BIT <CT_AUX_SOLVER,           parameters_type, MOMS_type>,
    ...
    private:
      ...
      void remove_non_accepted_and_bennett_spins_from_Gamma(int& Gamma_up_size,
                                                            int& Gamma_dn_size);
      ...
      double compute_determinant_ratio(int random_vertex_ind, HS_spin_states_type new_HS_spin_value, bool Bennett);
      double calculate_acceptace_ratio(double ratio, HS_vertex_move_type HS_current_move, double QMC_factor);

      bool assert_exp_delta_V_value(HS_field_sign       HS_field,
    ...
    template<LIN_ALG::device_type device_t, class parameters_type, class MOMS_type>
    MC_walker<CT_AUX_SOLVER, device_t, parameters_type, MOMS_type>::MC_walker(parameters_type& parameters_ref,
                                                                              MOMS_type&       MOMS_ref,
                                                                              rng_type&        rng_ref,
                                                                              int              id):
      ...
      stored_Gamma_up_CPU("stored_Gamma_up_CPU", Gamma_up.get_current_size(), Gamma_up.get_global_size()),
      stored_Gamma_dn_CPU("stored_Gamma_dn_CPU", Gamma_dn.get_current_size(), Gamma_dn.get_global_size()),
    ...
    template<LIN_ALG::device_type device_t, class parameters_type, class MOMS_type>
    LIN_ALG::matrix<double, device_t>& MC_walker<CT_AUX_SOLVER, device_t, parameters_type, MOMS_type>::get_N(e_spin_states_type e_spin)
    {
      if(e_spin == e_DN)
        return N_dn;
      else
    ...
    template<LIN_ALG::device_type device_t, class parameters_type, class MOMS_type>
    typename MC_walker<CT_AUX_SOLVER, device_t, parameters_type, MOMS_type>::configuration_type&
    MC_walker<CT_AUX_SOLVER, device_t, parameters_type, MOMS_type>::get_configuration()
    {
    ...
    void MC_walker<CT_AUX_SOLVER, device_t, parameters_type, MOMS_type>::do_sweep()
    {
      ...
      int nb_of_block_steps = 1 + floor(configuration.get_number_of_interacting_HS_spins()/parameters.get_K_PHANI()*factor);
    ...
    template<LIN_ALG::device_type device_t, class parameters_type, class MOMS_type>
    void MC_walker<CT_AUX_SOLVER, device_t, parameters_type, MOMS_type>::add_non_interacting_spins_to_configuration()
    {
      //profiler_type profiler(__FUNCTION__, "CT-AUX walker", __LINE__, thread_id);
    ...
    void MC_walker<CT_AUX_SOLVER, device_t, parameters_type, MOMS_type>::generate_delayed_spins()
    {
	  ...
	  //std::cout << "\t" << i << "\t";
          ...
          delayed_spins[i].QMC_factor = CV_obj.get_QMC_factor(configuration[random_vertex_ind], new_HS_spin_value);
          ...
          delayed_spins[i].configuration_e_spin_index_HS_field_DN = configuration[random_vertex_ind].get_configuration_e_spin_indices().first;
          delayed_spins[i].configuration_e_spin_index_HS_field_UP = configuration[random_vertex_ind].get_configuration_e_spin_indices().second;
	      ...
	      Gamma_up_size += 1;
              ...
              vertex_singleton_type& v_j = configuration.get(e_UP)[delayed_spins[i].configuration_e_spin_index_HS_field_DN];
              ...
              delayed_spins[i].exp_minus_delta_V_HS_field_DN = CV_obj.exp_minus_delta_V(v_j, new_HS_spin_value);
            }
          else
            {
	      ...
	      Gamma_dn_size += 1;
              ...
              vertex_singleton_type& v_j = configuration.get(e_DN)[delayed_spins[i].configuration_e_spin_index_HS_field_DN];
	      ...
	      Gamma_up_size += 1;
              ...
              vertex_singleton_type& v_j = configuration.get(e_UP)[delayed_spins[i].configuration_e_spin_index_HS_field_UP];
	      ...
	      Gamma_dn_size += 1;
              ...
              vertex_singleton_type& v_j = configuration.get(e_DN)[delayed_spins[i].configuration_e_spin_index_HS_field_UP];
    ...
    void MC_walker<CT_AUX_SOLVER, device_t, parameters_type, MOMS_type>::read_Gamma_matrices(e_spin_states e_spin)
    {
      ...
      switch(e_spin)
        {
        case e_DN:
          CT_AUX_WALKER_TOOLS<device_t>::compute_Gamma(Gamma_dn, N_dn, G_dn, vertex_indixes, exp_V, exp_delta_V, thread_id, stream_id);
          break;

        case e_UP:
          CT_AUX_WALKER_TOOLS<device_t>::compute_Gamma(Gamma_up, N_up, G_up, vertex_indixes, exp_V, exp_delta_V, thread_id, stream_id);
          break;
    ...
    void MC_walker<CT_AUX_SOLVER, device_t, parameters_type, MOMS_type>::neutralize_delayed_spin(int& delayed_index, int& Gamma_up_size, int& Gamma_dn_size)
    {
      ...
      if(delayed_spins[delayed_index].e_spin_HS_field_DN == e_UP)
        {
          Gamma_up_size += 1;
          CT_AUX_WALKER_TOOLS<LIN_ALG::CPU>::set_to_identity(Gamma_up_CPU, delayed_spins[delayed_index].Gamma_index_HS_field_DN);
        }
      else
        {
          Gamma_dn_size += 1;
          CT_AUX_WALKER_TOOLS<LIN_ALG::CPU>::set_to_identity(Gamma_dn_CPU, delayed_spins[delayed_index].Gamma_index_HS_field_DN);
        }

      if(delayed_spins[delayed_index].e_spin_HS_field_UP == e_UP)
        {
          Gamma_up_size += 1;
          CT_AUX_WALKER_TOOLS<LIN_ALG::CPU>::set_to_identity(Gamma_up_CPU, delayed_spins[delayed_index].Gamma_index_HS_field_UP);
        }
      else
        {
          Gamma_dn_size += 1;
          CT_AUX_WALKER_TOOLS<LIN_ALG::CPU>::set_to_identity(Gamma_dn_CPU, delayed_spins[delayed_index].Gamma_index_HS_field_UP);
        }
    }
          ...
          if((not delayed_spins[i].is_accepted_move) or delayed_spins[i].is_a_bennett_spin)
            {
              ...
              if(e_spin_HS_field_UP == e_UP)
                {
                  Gamma_up_size -= 1;
                  CT_AUX_WALKER_TOOLS<LIN_ALG::CPU>::remove_row_and_column(Gamma_up_CPU, Gamma_index_HS_field_UP);
                }
              else
                {
                  Gamma_dn_size -= 1;
                  CT_AUX_WALKER_TOOLS<LIN_ALG::CPU>::remove_row_and_column(Gamma_dn_CPU, Gamma_index_HS_field_UP);
                }

              if(e_spin_HS_field_DN == e_UP)
                {
                  Gamma_up_size -= 1;
                  CT_AUX_WALKER_TOOLS<LIN_ALG::CPU>::remove_row_and_column(Gamma_up_CPU, Gamma_index_HS_field_DN);
                }
              else
                {
                  Gamma_dn_size -= 1;
                  CT_AUX_WALKER_TOOLS<LIN_ALG::CPU>::remove_row_and_column(Gamma_dn_CPU, Gamma_index_HS_field_DN);
                }
            }
        }

      assert(Gamma_up_size == Gamma_up_CPU.get_current_size().first and Gamma_up_size == Gamma_up_CPU.get_current_size().second);
      assert(Gamma_dn_size == Gamma_dn_CPU.get_current_size().first and Gamma_dn_size == Gamma_dn_CPU.get_current_size().second);
    }
    ...
    void MC_walker<CT_AUX_SOLVER, device_t, parameters_type, MOMS_type>::add_delayed_spin(int& delayed_index, int& Gamma_up_size, int& Gamma_dn_size)
    {
      ...
      assert(assert_exp_delta_V_value(HS_FIELD_UP,
                                      delayed_spins[delayed_index].random_vertex_ind,
                                      delayed_spins[delayed_index].new_HS_spin_value,
        ...
        if(delayed_spins[delayed_index].e_spin_HS_field_DN == e_UP)
          {
            ...
            ratio_HS_field_DN = ctaux_tools.solve_Gamma_blocked(Gamma_index_HS_field_DN, Gamma_up_CPU, exp_delta_V_HS_field_DN, Gamma_up_diag_max, Gamma_up_diag_min);
        ...
        else
          {
            ...
            ratio_HS_field_DN = ctaux_tools.solve_Gamma_blocked(Gamma_index_HS_field_DN, Gamma_dn_CPU, exp_delta_V_HS_field_DN, Gamma_dn_diag_max, Gamma_dn_diag_min);
        ...
        if(delayed_spins[delayed_index].e_spin_HS_field_UP == e_UP)
          {
            ...
            ratio_HS_field_UP = ctaux_tools.solve_Gamma_blocked(Gamma_index_HS_field_UP, Gamma_up_CPU, exp_delta_V_HS_field_UP, Gamma_up_diag_max, Gamma_up_diag_min);
        ...
        else
          {
            ...
            ratio_HS_field_UP = ctaux_tools.solve_Gamma_blocked(Gamma_index_HS_field_UP, Gamma_dn_CPU, exp_delta_V_HS_field_UP, Gamma_dn_diag_max, Gamma_dn_diag_min);
    ...
    void MC_walker<CT_AUX_SOLVER, device_t, parameters_type, MOMS_type>::apply_bennett_on_Gamma_matrices(int& /*Gamma_up_size*/, int& /*Gamma_dn_size*/)
    {
      ...
      /*
        ...
        ratio_HS_field_DN = ctaux_tools.apply_bennett_on_Gamma(index, Gamma_up_size, Gamma_up_CPU, exp_minus_delta_V);
        }
        else
        {
        int    index             = bennett_spins[bennett_index].Gamma_index_HS_field_DN;
        ...
        ratio_HS_field_DN = ctaux_tools.apply_bennett_on_Gamma(index, Gamma_dn_size, Gamma_dn_CPU, exp_minus_delta_V);
        }
        ...
        ratio_HS_field_UP = ctaux_tools.apply_bennett_on_Gamma(index, Gamma_up_size, Gamma_up_CPU, exp_minus_delta_V);
        }
        else
        {
        int    index             = bennett_spins[bennett_index].Gamma_index_HS_field_UP;
        ...
        ratio_HS_field_UP = ctaux_tools.apply_bennett_on_Gamma(index, Gamma_dn_size, Gamma_dn_CPU, exp_minus_delta_V);
        }
    ...
    template<LIN_ALG::device_type device_t, class parameters_type, class MOMS_type>
    int MC_walker<CT_AUX_SOLVER, device_t, parameters_type, MOMS_type>::get_new_vertex_index(HS_vertex_move_type HS_current_move)
    {
    ...
    template<LIN_ALG::device_type device_t, class parameters_type, class MOMS_type>
    HS_spin_states_type MC_walker<CT_AUX_SOLVER, device_t, parameters_type, MOMS_type>::get_new_spin_value(HS_vertex_move_type HS_current_move)
    {
      if(HS_current_move == CREATION)
        {
          if(rng.get_random_number() > 0.50000000)
    ...
    template<LIN_ALG::device_type device_t, class parameters_type, class MOMS_type>
    double MC_walker<CT_AUX_SOLVER, device_t, parameters_type, MOMS_type>::calculate_acceptace_ratio(double              determinant_ratio,
                                                                                                     HS_vertex_move_type HS_current_move,
                                                                                                     double              QMC_factor)
    {
    ...
    template<LIN_ALG::device_type device_t, class parameters_type, class MOMS_type>
    bool MC_walker<CT_AUX_SOLVER, device_t, parameters_type, MOMS_type>::assert_exp_delta_V_value(HS_field_sign       HS_field,
                                                                                                  int                 random_vertex_ind,
                                                                                                  HS_spin_states_type new_HS_spin_value,
                                                                                                  double              exp_delta_V)
    {
        ...
        case HS_FIELD_DN:
          {
            ...
            int configuration_e_spin_index_HS_field_DN = configuration[random_vertex_ind].get_configuration_e_spin_indices().first;
        ...
        case HS_FIELD_UP:
          {
            ...
            int configuration_e_spin_index_HS_field_UP = configuration[random_vertex_ind].get_configuration_e_spin_indices().second;
