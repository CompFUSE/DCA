...
#ifndef PHYS_LIBRARY_DCA_STEP_CLUSTER_SOLVER_CLUSTER_SOLVER_MC_CTAUX_CTAUX_ACCUMULATOR_TP_ACCUMULATOR_CTAUX_ACCUMULATOR_EQUAL_TIME_OPERATOR_H
#define PHYS_LIBRARY_DCA_STEP_CLUSTER_SOLVER_CLUSTER_SOLVER_MC_CTAUX_CTAUX_ACCUMULATOR_TP_ACCUMULATOR_CTAUX_ACCUMULATOR_EQUAL_TIME_OPERATOR_H
 ...
 */
template <class parameters_type, class MOMS_type>
void MC_two_particle_equal_time_accumulator<parameters_type, MOMS_type>::accumulate_dwave_pp_correlator(
    double sign) {
...
template <class parameters_type, class MOMS_type>
int MC_two_particle_equal_time_accumulator<parameters_type, MOMS_type>::find_first_non_interacting_spin(
...
template <class parameters_type, class MOMS_type>
inline double MC_two_particle_equal_time_accumulator<parameters_type, MOMS_type>::interpolate_akima(
...
#endif  // PHYS_LIBRARY_DCA_STEP_CLUSTER_SOLVER_CLUSTER_SOLVER_MC_CTAUX_CTAUX_ACCUMULATOR_TP_ACCUMULATOR_CTAUX_ACCUMULATOR_EQUAL_TIME_OPERATOR_H
