      ...
      void accumulator_nonlocal_G<parameters_type, MOMS_type>::FT_M_v_v_2_M_k_k_w_w_test()
      {
...

        {
          ...
          double time_2=0;
          {
            ...
            MATH_ALGORITHMS::TRANSFORM<r_PCM, k_PCM>::execute(tmp_RR_2, tmp_KR_2);
            MATH_ALGORITHMS::TRANSFORM<r_PCM, k_PCM>::execute(tmp_KR_2, tmp_KK_2);

            //      MATH_ALGORITHMS::TRANSFORM<r_PCM, k_PCM>::execute_on_all(tmp_RR_2, tmp_KK_2);
