...
#ifndef DCA_QMCI_G0_INTERPOLATION_GPU_CU_H
#define DCA_QMCI_G0_INTERPOLATION_GPU_CU_H
  ...
  namespace QMCI
  {
    namespace G0_INTERPOLATION_KERNELS
    {
                                        ...
                                        double* grad_G0_r_t, std::pair<int,int> grad_G0_r_t_cs, std::pair<int,int> grad_G0_r_t_gs)
      {
        ...
        interpolation_kernel<<<blocks, threads>>>(Nb, Nr, Nt, beta, Nv, b, r, t,
                                                  G0         , G0_cs         , G0_gs         ,
      ...
      */
      ...
      __global__ void akima_interpolation_fat_column(int Nb,
                                                     int Nr,
                                                     int Nt,
                                                     double beta,
                                                     int     Nc,
            ...
            for(int J=J_min; J<J_max; ++J)
              {
                ...
                G0[I+G0_gs.first*J] = -(a_ptr[0] + delta_tau*(a_ptr[1] + delta_tau*(a_ptr[2] + delta_tau*a_ptr[3])));
              }
          }
      ...
      __global__ void akima_interpolation_fat_row(int Nb,
                                                  int Nr,
                                                  int Nt,
                                                  double beta,
                                                  int     Nc,
        ...
        if(Nv-Nc>0 and Nv>0)
          {
            ...
            akima_interpolation_fat_column<<<blocks, threads>>>(Nb, Nr, Nt, beta, Nc, Nv, b, r, t,
                                                                G0         , G0_cs         , G0_gs       ,
                                                                r0_min_r1  , r0_min_r1_cs  , r0_min_r1_gs,
        ...
        if(Nv-Nc>0 and Nc>0)
          {
            ...
            akima_interpolation_fat_row<<<blocks, threads>>>(Nb, Nr, Nt, beta, Nc, Nv, b, r, t,
                                                             G0         , G0_cs         , G0_gs       ,
                                                             r0_min_r1  , r0_min_r1_cs  , r0_min_r1_gs,
                                                             alpha      , alpha_cs      , alpha_gs    );
        ...
        if(Nv-Nc>0 and Nv>0)
          {
            ...
            akima_interpolation_fat_column<<<blocks, threads, 0, stream_handle>>>(Nb, Nr, Nt, beta, Nc, Nv, b, r, t,
                                                                                  G0         , G0_cs         , G0_gs       ,
                                                                                  r0_min_r1  , r0_min_r1_cs  , r0_min_r1_gs,
                                                                                  alpha      , alpha_cs      , alpha_gs    );
        ...
        if(Nv-Nc>0 and Nc>0)
          {
            ...
            akima_interpolation_fat_row<<<blocks, threads, 0, stream_handle>>>(Nb, Nr, Nt, beta, Nc, Nv, b, r, t,
                                                                               G0         , G0_cs         , G0_gs       ,
                                                                               r0_min_r1  , r0_min_r1_cs  , r0_min_r1_gs,
                                                                               alpha      , alpha_cs      , alpha_gs    );
