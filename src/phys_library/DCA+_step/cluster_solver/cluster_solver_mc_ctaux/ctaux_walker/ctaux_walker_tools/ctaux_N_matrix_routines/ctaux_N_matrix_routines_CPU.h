...
namespace DCA
{
  namespace QMCI
  {
    ...
    template<typename parameters_type>
    N_MATRIX_TOOLS<LIN_ALG::CPU, parameters_type>::N_MATRIX_TOOLS(int              id,
                                                                  parameters_type& parameters_ref):
      thread_id(id),
      stream_id(0),
    ...
    template<typename parameters_type>
    double* N_MATRIX_TOOLS<LIN_ALG::CPU, parameters_type>::get_device_ptr(LIN_ALG::vector<double, LIN_ALG::CPU>& v){
      return v.get_ptr();
    }
    ...
    template<typename parameters_type>
    void N_MATRIX_TOOLS<LIN_ALG::CPU, parameters_type>::set_d_vector(LIN_ALG::vector<double, LIN_ALG::CPU>& d_inv)
    {
      d_vec.set(d_inv);
    }
    ...
    void N_MATRIX_TOOLS<LIN_ALG::CPU, parameters_type>::scale_rows(LIN_ALG::matrix<double, LIN_ALG::CPU>& N)
    {
      ...
      LIN_ALG::SCALE<LIN_ALG::CPU>::many_rows(N_c, N_i,
                                              permutation.get_ptr(),
                                              d_vec      .get_ptr(),
                                              N          .get_ptr(), N_LD,
                                              thread_id, stream_id);
    ...
    template<typename parameters_type>
    void N_MATRIX_TOOLS<LIN_ALG::CPU, parameters_type>::copy_rows(LIN_ALG::matrix<double, LIN_ALG::CPU>& N,
                                                                  LIN_ALG::matrix<double, LIN_ALG::CPU>& N_new_spins)
    {
      ...
      LIN_ALG::COPY<LIN_ALG::CPU>::many_rows(N_c, N_i,
    ...
    template<typename parameters_type>
    void N_MATRIX_TOOLS<LIN_ALG::CPU, parameters_type>::compute_G_cols(std::vector<double>&                   exp_V,
                                                                       LIN_ALG::matrix<double, LIN_ALG::CPU>& N,
                                                                       LIN_ALG::matrix<double, LIN_ALG::CPU>& G,
                                                                       LIN_ALG::matrix<double, LIN_ALG::CPU>& G_cols)
    {
