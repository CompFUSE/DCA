...
#ifndef DCA_QMCI_SHRINK_ROUTINES_GPU_H
#define DCA_QMCI_SHRINK_ROUTINES_GPU_H
  ...
  namespace QMCI
  {
    ...
    public:
      ...
      void execute(std::vector<int>& source_index_up,
                   ...
                   LIN_ALG::matrix<double, LIN_ALG::GPU>& G0_up,
                   std::vector<int>& source_index_dn,
                   std::vector<int>& target_index_dn,
                   LIN_ALG::matrix<double, LIN_ALG::GPU>& N_dn,
