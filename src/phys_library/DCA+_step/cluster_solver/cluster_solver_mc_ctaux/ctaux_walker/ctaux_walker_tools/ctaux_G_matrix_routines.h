...
namespace DCA
{
  namespace QMCI
  {
    ...
    public:
      ...
      double compute_G_matrix_element(int                                 configuration_e_spin_index_i,
      ...
      void compute_row_on_Gamma_matrix(int                                row_index,
                                       LIN_ALG::vector<int   , device_t>& indices,
    ...
    template<LIN_ALG::device_type device_t, typename parameters_type>
    G_TOOLS<device_t, parameters_type>::G_TOOLS(int                                     id,
      ...
      if(N.get_current_size().first > 0 && vertex_index < configuration_e_spin.size())
        {
          ...
          LIN_ALG::GEMM<device_t>::execute('N', 'N', m, n, k, 1., N.get_ptr(0,0), LD_N, G0.get_ptr(0,vertex_index), LD_G0, 0., G.get_ptr(0,0), LD_G, thread_id, stream_id);
     ...
     */
    template<LIN_ALG::device_type device_t, typename parameters_type>
    inline double G_TOOLS<device_t, parameters_type>::compute_G_matrix_element(int                                 configuration_e_spin_index_i,
                                                                               int                                 configuration_e_spin_index_j,
                                                                               LIN_ALG::matrix<double, device_t>&  N,
                                                                               LIN_ALG::matrix<double, device_t>&  G_precomputed,
                                                                               std::vector<vertex_singleton_type>& configuration_e_spin)
    {
      ...
      if(configuration_e_spin_index_j<vertex_index)
        result = compute_G_vertex_to_old_vertex(configuration_e_spin_index_i, configuration_e_spin_index_j, N, configuration_e_spin);
      else
        result = compute_G_vertex_to_new_vertex(configuration_e_spin_index_i, configuration_e_spin_index_j-vertex_index, G_precomputed);
     ...
     */
    template<LIN_ALG::device_type device_t, typename parameters_type>
    inline void G_TOOLS<device_t, parameters_type>::compute_G_matrix_element(LIN_ALG::vector<int   , LIN_ALG::CPU>& i_index,
                                                                             LIN_ALG::vector<int   , LIN_ALG::CPU>& j_index,
                                                                             LIN_ALG::vector<bool  , LIN_ALG::CPU>& is_Bennett,
                                                                             LIN_ALG::vector<double, LIN_ALG::CPU>& exp_Vj,
                                                                             LIN_ALG::matrix<double, device_t>& N,
                                                                             ...
                                                                             int                                incr)
    {
      G_MATRIX_TOOLS<device_t, parameters_type>::read_G_matrix_elements(i_index, j_index, is_Bennett, exp_Vj, N, G_precomputed, result_ptr, incr);
    }
     ...
     */
    template<LIN_ALG::device_type device_t, typename parameters_type>
    inline void G_TOOLS<device_t, parameters_type>::compute_row_on_Gamma_matrix(int                                row_index,
                                                                                LIN_ALG::vector<int   , device_t>& indices,
                                                                                LIN_ALG::vector<double, device_t>& exp_V,
                                                                                LIN_ALG::matrix<double, device_t>& N,
                                                                                LIN_ALG::matrix<double, device_t>& G_precomputed,
                                                                                ...
                                                                                int                                incr)
    {
      ...
      G_MATRIX_TOOLS<device_t, parameters_type>::compute_row_on_Gamma_matrix(row_index, indices, exp_V, N, G_precomputed, result_ptr, incr);
    }
     ...
     */
    template<LIN_ALG::device_type device_t, typename parameters_type>
    inline void G_TOOLS<device_t, parameters_type>::compute_col_on_Gamma_matrix(int                                col_index,
                                                                                LIN_ALG::vector<int   , device_t>& indices,
                                                                                LIN_ALG::vector<double, device_t>& exp_V,
                                                                                LIN_ALG::matrix<double, device_t>& N,
                                                                                LIN_ALG::matrix<double, device_t>& G_precomputed,
                                                                                ...
                                                                                int                                incr)
    {
      ...
      G_MATRIX_TOOLS<device_t, parameters_type>::compute_col_on_Gamma_matrix(col_index, indices, exp_V, N, G_precomputed, result_ptr, incr);
    }
     ...
     */
    template<LIN_ALG::device_type device_t, typename parameters_type>
    inline double G_TOOLS<device_t, parameters_type>::compute_G_vertex_to_old_vertex(int                                 configuration_e_spin_index_i,
                                                                                     int                                 configuration_e_spin_index_j,
                                                                                     LIN_ALG::matrix<double, device_t>&  N,
                                                                                     std::vector<vertex_singleton_type>& configuration_e_spin)
    {
     ...
     */
    template<LIN_ALG::device_type device_t, typename parameters_type>
    inline double G_TOOLS<device_t, parameters_type>::compute_G_vertex_to_new_vertex(int                                configuration_e_spin_index_i,
                                                                                     int                                configuration_e_spin_index_j,
                                                                                     LIN_ALG::matrix<double, device_t>& G)
    {
