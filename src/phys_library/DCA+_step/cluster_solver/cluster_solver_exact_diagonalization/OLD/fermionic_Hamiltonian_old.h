...
//     typedef fermionic_state   <b_dmn, s_dmn, r_dmn> f_state;
  ...
  private:
    ...
    function<long long, dmn_2<occ_dmn, mag_dmn> >& n_occupation_states;
    function<int*     , dmn_2<occ_dmn, mag_dmn> >& occupation_states;
    ...
    function<std::complex<scalartype>*, dmn_2<occ_dmn, mag_dmn> > Hamiltonians;	  

    function<double*                  , dmn_2<occ_dmn, mag_dmn> > eigen_energies;	  
    function<std::complex<scalartype>*, dmn_2<occ_dmn, mag_dmn> > eigen_states;
