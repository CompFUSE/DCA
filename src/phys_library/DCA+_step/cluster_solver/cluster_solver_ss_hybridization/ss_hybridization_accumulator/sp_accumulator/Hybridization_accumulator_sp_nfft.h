...
#include "type_definitions.h"
    ...
    public:
      ...
      void accumulate(double              current_sign, 
...
//                    function<std::complex<double>, dmn_4<nu, nu, r_dmn_t, w> >& GS_r_w);
    ...
    private:
      ...
      double compute_U_times_n_2(configuration_type& configuration,
				 H_type&             H_interactions,
				 double              t_start,
				 int                 flavor);
    ...
    */
    ...
    template<class parameters_type, class base_cluster_type>
    template<class configuration_type, class M_matrices_type, class H_type>
    void MC_single_particle_accumulator<SS_CT_HYB, NFFT, parameters_type, base_cluster_type>::accumulate(double              current_sign, 
													 configuration_type& configuration,
													 M_matrices_type&    M_matrices,
													 H_type&             H_interactions)
    {
            ...
            for(int i=0; i<(int)segments.size(); i++)
              {
                ...
                cached_nfft_1D_GS_obj.accumulate_at(coor_nfft, scaled_tau, U_times_n*M_ind(j,i)*current_sign);
              }
          }
    ...
    */
    ...
    template<class parameters_type, class base_cluster_type>
    template<class configuration_type, class H_type>
    double MC_single_particle_accumulator<SS_CT_HYB, NFFT, parameters_type, base_cluster_type>::compute_U_times_n_2(configuration_type& configuration,
														    H_type&             H_interactions,
														    double              t_start,
														    int                 flavor)
    {
