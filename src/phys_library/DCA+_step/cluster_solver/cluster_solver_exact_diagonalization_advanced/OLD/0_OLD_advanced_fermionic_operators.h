...
#ifndef ADVANCED_FERMIONIC_OPERATORS_H
#define ADVANCED_FERMIONIC_OPERATORS_H
...
//     template<typename parameter_type, typename ed_options>
//     void operators<parameter_type, ed_options>::create_at(int_type l, psi_state<parameter_type, ed_options>& Psi)
//     {
//       for (int_type i = 0; i < Psi.size(); ++i)
//  {
//    if (Psi.get_phi(i).test(l))
//      {
//        Psi.erase(i);
//      }
//         else
...
//        {
//          int_type tmp = (1<<l) - 1;
//          std::bitset<N> mask(tmp);
//          bool change_sign = ((Psi.get_phi(i) & mask).count()) & 1;
//          if (change_sign){
//            Psi.get_alpha(i) *= -1.;
//          }
...
//     template<typename parameter_type, typename ed_options>
//     void operators<parameter_type, ed_options>::annihilate_at(int_type l, psi_state<parameter_type, ed_options>& Psi)
//     {
//       for(int_type i = 0; i < Psi.size(); ++i)
//  {
//    if (Psi.get_phi(i).test(l)) {
//      Psi.get_phi(i).reset(l);
...
//     template<typename parameter_type, typename ed_options>
//     int operators<parameter_type, ed_options>::create(int l, phi_type& phi)
//     {
//       phi.set(l);
