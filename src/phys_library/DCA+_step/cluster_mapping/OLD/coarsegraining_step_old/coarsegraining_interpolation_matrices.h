...
namespace DCA
{
  ...
  template<typename scalar_type, typename k_dmn, typename K_dmn, COARSEGRAIN_DOMAIN_NAMES NAME>
  template<typename concurrency_type>
  void interpolation_matrices<scalar_type, k_dmn, dmn_0<coarsegraining_domain<K_dmn, NAME> > >::print_memory_used(concurrency_type& concurrency)
  {
    if(concurrency.id()==0)
      {
  ...
  template<typename scalar_type, typename k_dmn, typename K_dmn, COARSEGRAIN_DOMAIN_NAMES NAME>
  template<typename concurrency_type>
  void interpolation_matrices<scalar_type, k_dmn, dmn_0<coarsegraining_domain<K_dmn, NAME> > >::initialize(concurrency_type& concurrency)
  {
  ...
  template<typename scalar_type, typename k_dmn, typename K_dmn, COARSEGRAIN_DOMAIN_NAMES NAME>
  template<typename concurrency_type>
  void interpolation_matrices<scalar_type, k_dmn, dmn_0<coarsegraining_domain<K_dmn, NAME > > >::initialize(concurrency_type& concurrency, int Q_ind)
  {
  ...
  template<typename scalar_type, typename k_dmn, typename K_dmn, COARSEGRAIN_DOMAIN_NAMES NAME>
  template<typename scalar_type_1, typename scalar_type_2>
  void interpolation_matrices<scalar_type, k_dmn, dmn_0<coarsegraining_domain<K_dmn, NAME> > >::cast(scalar_type_1& x, scalar_type_2& y)
  {
    x = y;
  }
