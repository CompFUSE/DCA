...
namespace DCA
{
  ...
  void interpolation_matrices<scalar_type, k_dmn, dmn_0<coarsegraining_domain<K_dmn, K_PLUS_Q> > >::initialize(concurrency_type& concurrency, int Q_ind)
  {
    if(is_initialized())
      return;
  ...
  template<typename scalar_type, typename k_dmn, typename K_dmn>
  template<typename scalar_type_1, typename scalar_type_2>
  void interpolation_matrices<scalar_type, k_dmn, dmn_0<coarsegraining_domain<K_dmn, K_PLUS_Q> > >::cast(scalar_type_1& x, scalar_type_2& y)
  {
    x = y;
  }
  ...
  template<typename scalar_type, typename k_dmn, typename K_dmn>
  template<typename scalar_type_1, typename scalar_type_2>
  void interpolation_matrices<scalar_type, k_dmn, dmn_0<coarsegraining_domain<K_dmn, K_PLUS_Q> > >::cast(scalar_type_1& x, std::complex<scalar_type_2>& y)
  {
