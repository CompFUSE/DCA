...
#ifndef PHYS_LIBRARY_DCA_STEP_CLUSTER_MAPPING_ADJUST_CHEMICAL_POTENTIAL_H
#define PHYS_LIBRARY_DCA_STEP_CLUSTER_MAPPING_ADJUST_CHEMICAL_POTENTIAL_H
...
#endif  // PHYS_LIBRARY_DCA_STEP_CLUSTER_MAPPING_ADJUST_CHEMICAL_POTENTIAL_H
