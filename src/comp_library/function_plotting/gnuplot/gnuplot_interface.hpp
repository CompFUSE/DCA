...
#ifndef SRC_COMP_LIBRARY_FUNCTION_PLOTTING_GNUPLOT_GNUPLOT_INTERFACE_HPP
#define SRC_COMP_LIBRARY_FUNCTION_PLOTTING_GNUPLOT_GNUPLOT_INTERFACE_HPP
...
public:
  ...
  ///   from file
  Gnuplot& plotfile_x(const std::string& filename, const unsigned int column = 1,
  ...
  /// plot x,y pairs: x y
  ///   from file
  Gnuplot& plotfile_xy(const std::string& filename, const unsigned int column_x = 1,
  ...
  ///   from file
  Gnuplot& plotfile_xy_err(const std::string& filename, const unsigned int column_x = 1,
  ...
  ///   from file
  Gnuplot& plotfile_xyz(const std::string& filename, const unsigned int column_x = 1,
  ...
  template <typename X, typename Y, typename Z>
  std::string write_xyz(const X& x, const Y& y, const Z& z);
  ...
  /// elementary functions: rand(x), abs(x), sgn(x), ceil(x), floor(x), int(x), imag(x), real(x),
  /// arg(x),
  ///   sqrt(x), exp(x), log(x), log10(x), sin(x), cos(x), tan(x), asin(x), acos(x), atan(x),
  ///   atan2(y,x),
  ...
  /// plot image
  Gnuplot& plot_image(const char* ucPicBuf, const int iWidth, const int iHeight,
                      const std::string& title = "");
...
//
inline Gnuplot::Gnuplot(const std::vector<double>& x, const std::vector<double>& y,
...
//
template <typename X, typename Y, typename Z>
std::string Gnuplot::write_xyz(const X& x, const Y& y, const Z& z) {
  if (x.size() == 0 || y.size() == 0 || z.size() == 0)
    throw GnuplotException("std::vectors too small");
...
Gnuplot& Gnuplot::set_style(const std::string& stylestr) {
  if (stylestr.find("lines") == std::string::npos && stylestr.find("points") == std::string::npos &&
      stylestr.find("linespoints") == std::string::npos &&
      stylestr.find("impulses") == std::string::npos && stylestr.find("dots") == std::string::npos &&
      stylestr.find("steps") == std::string::npos && stylestr.find("fsteps") == std::string::npos &&
  ...
  //        stylestr.find("labels")         == std::string::npos  &&  // 3 columns of data are
  //        required
  //        stylestr.find("xerrorbars")     == std::string::npos  &&  // 3-4 columns of data are
  //        required
  //        stylestr.find("xerrorlines")    == std::string::npos  &&  // 3-4 columns of data are
  //        required
  //        stylestr.find("errorbars")      == std::string::npos  &&  // 3-4 columns of data are
  //        required
  //        stylestr.find("errorlines")     == std::string::npos  &&  // 3-4 columns of data are
  //        required
  //        stylestr.find("yerrorbars")     == std::string::npos  &&  // 3-4 columns of data are
  //        required
  //        stylestr.find("yerrorlines")    == std::string::npos  &&  // 3-4 columns of data are
  //        required
  //        stylestr.find("boxerrorbars")   == std::string::npos  &&  // 3-5 columns of data are
  //        required
  //        stylestr.find("xyerrorbars")    == std::string::npos  &&  // 4,6,7 columns of data are
  //        required
  //        stylestr.find("xyerrorlines")   == std::string::npos  &&  // 4,6,7 columns of data are
  //        required
  //        stylestr.find("boxxyerrorbars") == std::string::npos  &&  // 4,6,7 columns of data are
  //        required
  //        stylestr.find("financebars")    == std::string::npos  &&  // 5 columns of data are
  //        required
  //        stylestr.find("candlesticks")   == std::string::npos  &&  // 5 columns of data are
  //        required
...
Gnuplot& Gnuplot::set_smooth(const std::string& stylestr) {
  if (stylestr.find("unique") == std::string::npos &&
      ...
      stylestr.find("bezier") == std::string::npos && stylestr.find("sbezier") == std::string::npos) {
    smooth = "";
  }
  else {
    smooth = stylestr;
...
Gnuplot& Gnuplot::set_contour(const std::string& position) {
  if (position.find("base") == std::string::npos && position.find("surface") == std::string::npos &&
...
//
Gnuplot& Gnuplot::plotfile_x(const std::string& filename, const unsigned int column,
                             const std::string& title) {
  //
...
//
Gnuplot& Gnuplot::plotfile_xy(const std::string& filename, const unsigned int column_x,
...
//
Gnuplot& Gnuplot::plotfile_xy_err(const std::string& filename, const unsigned int column_x,
                                  const unsigned int column_y, const unsigned int column_dy,
                                  const std::string& title) {
  //
  // check if file exists
  //
  ...
  cmdstr << "\"" << filename << "\" using " << column_x << ":" << column_y << ":" << column_dy
         << " with errorbars ";
...
//
Gnuplot& Gnuplot::plotfile_xyz(const std::string& filename, const unsigned int column_x,
...
//
Gnuplot& Gnuplot::plot_image(const char* ucPicBuf, const int iWidth, const int iHeight,
                             const std::string& title) {
  std::ofstream tmp;
  std::string name = create_tmpfile(tmp);
  if (name == "")
