...
template< typename domain_0_t,
		  ...
		  typename domain_10_t,
		  typename domain_11_t>
union_12<domain_0_t, domain_1_t, domain_2_t, domain_3_t, domain_4_t, domain_5_t, domain_6_t, domain_7_t, domain_8_t, domain_9_t, domain_10_t, domain_11_t>::union_12():
	domain(),
	domain_0(),
	domain_1(),
	domain_2(),
	...
	domain_11()
{
	...
	size = domain_0.get_size() + domain_1.get_size() + domain_2.get_size() + domain_3.get_size() + domain_4.get_size() + domain_5.get_size() + domain_6.get_size() + domain_7.get_size() + domain_8.get_size() + domain_9.get_size() + domain_10.get_size() + domain_11.get_size();
...
template< typename domain_0_t,
		  ...
		  typename domain_10_t,
		  typename domain_11_t>
void union_12<domain_0_t, domain_1_t, domain_2_t, domain_3_t, domain_4_t, domain_5_t, domain_6_t, domain_7_t, domain_8_t, domain_9_t, domain_10_t, domain_11_t>::reset()
{
domain::reset();
...
template< typename domain_0_t,
		  ...
		  typename domain_10_t,
		  typename domain_11_t>
int union_12<domain_0_t, domain_1_t, domain_2_t, domain_3_t, domain_4_t, domain_5_t, domain_6_t, domain_7_t, domain_8_t, domain_9_t, domain_10_t, domain_11_t>::operator()(int l)
{
	 assert(l>=0 && l<size);
	 return l;
}
