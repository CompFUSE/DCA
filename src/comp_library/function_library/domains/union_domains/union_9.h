...
template< typename domain_0_t,
		  ...
		  typename domain_7_t,
		  typename domain_8_t>
union_9<domain_0_t, domain_1_t, domain_2_t, domain_3_t, domain_4_t, domain_5_t, domain_6_t, domain_7_t, domain_8_t>::union_9():
	domain(),
	domain_0(),
	domain_1(),
	domain_2(),
	...
	domain_8()
{
	...
	size = domain_0.get_size() + domain_1.get_size() + domain_2.get_size() + domain_3.get_size() + domain_4.get_size() + domain_5.get_size() + domain_6.get_size() + domain_7.get_size() + domain_8.get_size();
...
template< typename domain_0_t,
		  ...
		  typename domain_7_t,
		  typename domain_8_t>
void union_9<domain_0_t, domain_1_t, domain_2_t, domain_3_t, domain_4_t, domain_5_t, domain_6_t, domain_7_t, domain_8_t>::reset()
{
domain::reset();
...
template< typename domain_0_t,
		  ...
		  typename domain_7_t,
		  typename domain_8_t>
int union_9<domain_0_t, domain_1_t, domain_2_t, domain_3_t, domain_4_t, domain_5_t, domain_6_t, domain_7_t, domain_8_t>::operator()(int l)
{
	 assert(l>=0 && l<size);
	 return l;
}
