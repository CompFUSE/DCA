...
namespace JsonParser 
{
  ...
  public:
    ...
    static state_and_action_pair get_state_and_action_pair(JSON_state_type& state, CharacterClass& cls);

  private:

    static bool check_state_and_class(JSON_state_type& state, CharacterClass& cls);

    static state_and_action_pair begin_object_or_array(CharacterClass& cls);

    static state_and_action_pair begin_value(CharacterClass& cls);
    static state_and_action_pair end_value  (CharacterClass& cls);

    static state_and_action_pair begin_string(CharacterClass& cls);
    static state_and_action_pair read_string (CharacterClass& cls);

    static state_and_action_pair read_integer(CharacterClass& cls);
    static state_and_action_pair read_fraction(CharacterClass& cls);

    static state_and_action_pair begin_exponent(CharacterClass& cls);
    static state_and_action_pair read_exponent(CharacterClass& cls);

    static state_and_action_pair read_NULL(JSON_state_type& state, CharacterClass& cls);

    static state_and_action_pair read_false(JSON_state_type& state, CharacterClass& cls);
    static state_and_action_pair read_true (JSON_state_type& state, CharacterClass& cls);

    static state_and_action_pair read_array(JSON_state_type& state, CharacterClass& cls);
  };

  bool JSON_translation_table::check_state_and_class(JSON_state_type& state, CharacterClass& cls) 
  {
    if(!(state < NR_STATES) || !(cls < NR_CLASSES) ) 
      {
	std::cout << "StateTranslationTable ("<< state << " < " << NR_STATES << "," << cls << " < " << NR_CLASSES << ")\n";
	std::cout << "StateTranslationTable ("<< name(state) << "," << clsName(cls) << ")\n";
  ...
  state_and_action_pair JSON_translation_table::get_state_and_action_pair(JSON_state_type& state, CharacterClass& cls) 
  {      
  ...
  state_and_action_pair JSON_translation_table::begin_object_or_array(CharacterClass& cls)
  {
    switch(cls) 
      {
  ...
  state_and_action_pair JSON_translation_table::begin_value(CharacterClass& cls)
  {
    switch(cls) 
      {
  ...
  state_and_action_pair JSON_translation_table::end_value(CharacterClass& cls)
  {
    switch(cls) 
      {
  ...
  state_and_action_pair JSON_translation_table::begin_string(CharacterClass& cls)
  {
    switch(cls) 
      {
  ...
  state_and_action_pair JSON_translation_table::read_string (CharacterClass& cls)
  {
    switch(cls) 
      {
  ...
  state_and_action_pair JSON_translation_table::read_integer(CharacterClass& cls)
  {
    switch (cls) 
      {
      case C_ZERO:
  ...
  state_and_action_pair JSON_translation_table::read_fraction(CharacterClass& cls)
  {
    switch (cls) 
      {
      case C_ZERO:
  ...
  state_and_action_pair JSON_translation_table::begin_exponent(CharacterClass& cls)
  {
    switch (cls) 
      {
      case C_MINUS:
  ...
  state_and_action_pair JSON_translation_table::read_exponent(CharacterClass& cls)
  {
    switch (cls) 
      {
      case C_ZERO:
  ...
  state_and_action_pair JSON_translation_table::read_NULL(JSON_state_type& state, CharacterClass& cls)
  {
    switch(state) 
      {
      case N: // Null
  ...
  state_and_action_pair JSON_translation_table::read_false(JSON_state_type& state, CharacterClass& cls)
  {
    switch(state) 
      {
      case F: // False
  ...
  state_and_action_pair JSON_translation_table::read_true(JSON_state_type& state, CharacterClass& cls)
  {
    switch(state) 
      {
      case T: // True
  ...
  state_and_action_pair JSON_translation_table::read_array(JSON_state_type& state, CharacterClass& cls)
  {
    switch(state) 
      {
      case A: // array
