...
namespace IO
{
  namespace JSONPARSER
  {
    ...
    private:
      ...
      void abort_parsing(wchar_t                   nextChar, 
      ...
      void performAction(wchar_t nextChar, JSON_character_class_type nextClass, JSON_state_type state, JSON_action_type action);
    ...
    template<typename context_type>
    void JSON_parser<context_type>::performAction(wchar_t                   nextChar, 
						  JSON_character_class_type nextClass, 
						  JSON_state_type           state,
						  JSON_action_type          action) 
    {
    ...
    template<typename context_type>
    void JSON_parser<context_type>::abort_parsing(wchar_t                   nextChar, 
						  JSON_character_class_type nextClass, 
						  JSON_state_type           state,
						  JSON_action_type          action)
    {
    ...
    template<typename context_type>
    std::pair<wchar_t, JSON_character_class_type> JSON_parser<context_type>::get_next_character_and_class(std::wistream& inputStream) 
    {
