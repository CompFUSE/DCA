...
#ifndef QMC_RESIZEABLE_SQUARE_MATRICES_TEMPLATE_H
#define QMC_RESIZEABLE_SQUARE_MATRICES_TEMPLATE_H
...
class resizeable_square_matrix_template
{

public:

  typedef scalartype                           matrix_scalartype;
  typedef resizeable_square_matrix_template<scalartype> this_type;

protected:

  resizeable_square_matrix_template();

  resizeable_square_matrix_template(int                 current_size);
...
template<typename scalartype>
resizeable_square_matrix_template<scalartype>::resizeable_square_matrix_template():
  current_size(0),
  global_size(64)
{
...
template<typename scalartype>
resizeable_square_matrix_template<scalartype>::resizeable_square_matrix_template(int crrnt_size):
...
template<  typename scalartype>
int& resizeable_square_matrix_template<scalartype>::get_current_size()
{
  return current_size;
}

template<  typename scalartype>
int resizeable_square_matrix_template<scalartype>::get_global_size()
{
  return global_size;
}

template<  typename scalartype>
void resizeable_square_matrix_template<scalartype>::get_size(std::pair<int,int>& current, std::pair<int,int>& global)
{
...
template<  typename scalartype>
inline scalartype& resizeable_square_matrix_template<scalartype>::operator()(int i, int j)
{
...
template<typename scalartype>
resizeable_square_matrix_template<scalartype>& resizeable_square_matrix_template<scalartype>::operator=(resizeable_square_matrix_template<scalartype>& M_other)
{
...
template<typename scalartype>
void resizeable_square_matrix_template<scalartype>::resize(int new_current_size)
{
...
template<typename scalartype>
void resizeable_square_matrix_template<scalartype>::resize_no_copy(int new_current_size)
{
  if(new_current_size > global_size)
    {
      current_size = new_current_size;
...
template<typename scalartype>
void resizeable_square_matrix_template<scalartype>::copy_from(this_type& other_matrix)
{
...
template<typename scalartype>
void resizeable_square_matrix_template<scalartype>::remove_row_and_column(int index)
{
  assert(index>=0);
...
template<typename scalartype>
void resizeable_square_matrix_template<scalartype>::remove_row_and_column(int index_row, int index_column)
{
...
template<typename scalartype>
void resizeable_square_matrix_template<scalartype>::swap_row_and_column(int i, int j)
{
...
template<typename scalartype>
void resizeable_square_matrix_template<scalartype>::cycle_column_forward()
{
...
template<typename scalartype>
void resizeable_square_matrix_template<scalartype>::cycle_column_backward()
{
  scalartype* tmp_column = new scalartype[current_size];
...
template<typename scalartype>
void resizeable_square_matrix_template<scalartype>::copy_row_and_column_into(int i, int j)
{
  assert(i>=0 && i<current_size && j>=0 && j<current_size);
  // j --> i
...
template<typename scalartype>
void resizeable_square_matrix_template<scalartype>::insert_row_and_column(int index)
{
...
template<  typename scalartype>
void resizeable_square_matrix_template<scalartype>::insert_row_and_column(int index_row, int index_column)
{
  assert(index_row>=0 && index_column>=0);
  assert(index_row<current_size && index_column<current_size);
...
template<typename scalartype>
void resizeable_square_matrix_template<scalartype>::insert_row_and_add_column(int index_row)
{
...
template<typename scalartype>
void resizeable_square_matrix_template<scalartype>::add_row_and_insert_column(int index_column)
{
...
template<typename scalartype>
bool resizeable_square_matrix_template<scalartype>::difference(this_type& mat)
{
...
template<typename scalartype>
void resizeable_square_matrix_template<scalartype>::print()
{
