...
#ifndef QMC_RESIZEABLE_SQUARE_MATRICES_GPU_H
#define QMC_RESIZEABLE_SQUARE_MATRICES_GPU_H
...
class resizeable_square_matrix<scalartype, GPU>
{

public:

  typedef scalartype                                matrix_scalartype;
  typedef resizeable_square_matrix<scalartype, GPU> this_type;
...
template<typename scalartype>
resizeable_square_matrix<scalartype, GPU>::resizeable_square_matrix():
  current_size(0),
  global_size(64)
{
    /*cuError_t ret =*/ cudaMalloc( (void**) data, current_size*global_size*sizeof(scalartype) );
    
    /*if( ret != cudaSuccess){
    std::cout << "NOT ENOUGH GPU MEMORY " << (current_size*global_size)*sizeof(cuda_scalartype) 
...
template<typename scalartype>
resizeable_square_matrix<scalartype, GPU>::resizeable_square_matrix(int crrnt_size):
  ...
  global_size(64)
{
  ...
  cudaError_t ret = cudaMalloc( (void**) data, current_size*global_size*sizeof(cuda_scalartype) );
...
template<  typename scalartype>
int& resizeable_square_matrix<scalartype, GPU>::get_current_size()
{
  return current_size;
}

template<  typename scalartype>
int resizeable_square_matrix<scalartype, GPU>::get_global_size()
{
  return global_size;
}

template<  typename scalartype>
void resizeable_square_matrix<scalartype, GPU>::get_size(std::pair<int,int>& current, std::pair<int,int>& global)
{
...
template<  typename scalartype>
inline scalartype& resizeable_square_matrix<scalartype, GPU>::operator()(int i, int j)
{
  assert(i>-1 && j>-1 && i<current_size && j<current_size);
  return data[i+global_size*j];
}

/*
template<typename scalartype>
resizeable_square_matrix<scalartype, GPU>& resizeable_square_matrix<scalartype, GPU>::operator=(resizeable_square_matrix<scalartype, GPU>& M_other)
{
...
template<typename scalartype>
void resizeable_square_matrix<scalartype, GPU>::resize(int new_current_size)
{
...
template<typename scalartype>
void resizeable_square_matrix<scalartype, GPU>::resize_no_copy(int new_current_size)
{
  if(new_current_size > global_size)
    {
      current_size = new_current_size;
...
template<typename scalartype>
void resizeable_square_matrix<scalartype, GPU>::copy_from(this_type& other_matrix)
{
...
template<typename scalartype>
void resizeable_square_matrix<scalartype, GPU>::remove_row_and_column(int index)
{
  assert(index>=0);
...
template<typename scalartype>
void resizeable_square_matrix<scalartype, GPU>::remove_row_and_column(int index_row, int index_column)
{
...
template<typename scalartype>
void resizeable_square_matrix<scalartype, GPU>::swap_row_and_column(int i, int j)
{
...
template<typename scalartype>
void resizeable_square_matrix<scalartype, GPU>::cycle_column_forward()
{
...
template<typename scalartype>
void resizeable_square_matrix<scalartype, GPU>::cycle_column_backward()
{
  scalartype* tmp_column = new scalartype[current_size];
...
template<typename scalartype>
void resizeable_square_matrix<scalartype, GPU>::copy_row_and_column_into(int i, int j)
{
  assert(i>=0 && i<current_size && j>=0 && j<current_size);
  // j --> i
...
template<typename scalartype>
void resizeable_square_matrix<scalartype, GPU>::insert_row_and_column(int index)
{
...
template<  typename scalartype>
void resizeable_square_matrix<scalartype, GPU>::insert_row_and_column(int index_row, int index_column)
{
  assert(index_row>=0 && index_column>=0);
  assert(index_row<current_size && index_column<current_size);
...
template<typename scalartype>
void resizeable_square_matrix<scalartype, GPU>::insert_row_and_add_column(int index_row)
{
...
template<typename scalartype>
void resizeable_square_matrix<scalartype, GPU>::add_row_and_insert_column(int index_column)
{
...
template<typename scalartype>
bool resizeable_square_matrix<scalartype, GPU>::difference(this_type& mat)
{
...
template<typename scalartype>
void resizeable_square_matrix<scalartype, GPU>::print()
{
