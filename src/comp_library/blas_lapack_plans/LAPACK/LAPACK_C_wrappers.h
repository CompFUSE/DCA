...
extern "C" void sgetrs_(char* TRANS, int* N, int* NRHS, float* A, int* LDA, int* IPIV, float* B,
                        int* LDB, int* INFO);
extern "C" void dgetrs_(char* TRANS, int* N, int* NRHS, double* A, int* LDA, int* IPIV, double* B,
                        int* LDB, int* INFO);
extern "C" void cgetrs_(char* TRANS, int* N, int* NRHS, std::complex<float>* A, int* LDA, int* IPIV,
                        std::complex<float>* B, int* LDB, int* INFO);
extern "C" void zgetrs_(char* TRANS, int* N, int* NRHS, std::complex<double>* A, int* LDA,
...
// std::complex<float>* W, std::complex<float>* VL, int* LDVL, std::complex<float>* VR, int* LDVR,
...
// std::complex<double>* W, std::complex<double>* VL, int* LDVL, std::complex<double>* VR, int*
// LDVR, std::complex<double>* WORK, int* LWORK, std::complex<double>* RWORK, int*   INFO );
extern "C" void cgeev_(char* JOBVL, char* JOBVR, int* N, std::complex<float>* A, int* LDA,
...
extern "C" void sgesvd_(char* JOBU, char* JOBVT, int* M, int* N, float* A, int* LDA, float* S,
...
extern "C" void cgesvd_(char* JOBU, char* JOBVT, int* M, int* N, std::complex<float>* A, int* LDA,
                        float* S, std::complex<float>* U, int* LDU, std::complex<float>* VT,
                        int* LDVT, std::complex<float>* WORK, int* LWORK, float* RWORK, int* INFO);
extern "C" void zgesvd_(char* JOBU, char* JOBVT, int* M, int* N, std::complex<double>* A, int* LDA,
                        double* S, std::complex<double>* U, int* LDU, std::complex<double>* VT,
...
extern "C" void sgesdd_(char* JOBZ, int* M, int* N, float* A, int* LDA, float* S, float* U, int* LDU,
...
extern "C" void cgesdd_(char* JOBZ, int* M, int* N, std::complex<float>* A, int* LDA, float* S,
                        std::complex<float>* U, int* LDU, std::complex<float>* VT, int* LDVT,
                        std::complex<float>* WORK, int* LWORK, float* RWORK, int* IWORK, int* INFO);
extern "C" void zgesdd_(char* JOBZ, int* M, int* N, std::complex<double>* A, int* LDA, double* S,
...
extern "C" void sgelss_(int* M, int* N, int* NRHS, float* A, int* LDA, float* B, int* LDB, float* S,
                        float* RCOND, int* RANK, float* WORK, int* LWORK, int* INFO);
extern "C" void dgelss_(int* M, int* N, int* NRHS, double* A, int* LDA, double* B, int* LDB,
                        double* S, double* RCOND, int* RANK, double* WORK, int* LWORK, int* INFO);
extern "C" void cgelss_(int* M, int* N, int* NRHS, std::complex<float>* A, int* LDA,
                        std::complex<float>* B, int* LDB, float* S, float* RCOND, int* RANK,
                        std::complex<float>* WORK, int* LWORK, float* RWORK, int* INFO);
extern "C" void zgelss_(int* M, int* N, int* NRHS, std::complex<double>* A, int* LDA,
                        std::complex<double>* B, int* LDB, double* S, double* RCOND, int* RANK,
                        std::complex<double>* WORK, int* LWORK, double* RWORK, int* INFO);

// generalized least square fit
extern "C" void sgglse_(int* M, int* N, int* P, float* A, int* LDA, float* B, int* LDB, float* C,
                        float* D, float* X, float* WORK, int* LWORK, int* INFO);
extern "C" void dgglse_(int* M, int* N, int* P, double* A, int* LDA, double* B, int* LDB, double* C,
                        double* D, double* X, double* WORK, int* LWORK, int* INFO);

// QR

extern "C" void sgeqp3_(int* M, int* N, float* A, int* LDA, int* JPVT, float* TAU, float* WORK,
                        int* LWORK, int* INFO);
extern "C" void dgeqp3_(int* M, int* N, double* A, int* LDA, int* JPVT, double* TAU, double* WORK,
                        int* LWORK, int* INFO);

extern "C" void sorgqr_(int* M, int* N, int* K, float* A, int* LDA, float* TAU, float* WORK,
                        int* LWORK, int* INFO);
