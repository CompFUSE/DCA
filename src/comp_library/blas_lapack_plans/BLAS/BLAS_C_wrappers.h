...
#ifndef BLAS_C_WRAPPER
#define BLAS_C_WRAPPER
...
extern "C" float sdot_(const int* size, const float* v1, const int* inc, const float* v2,
                       const int* inc2);
extern "C" double ddot_(const int* size, const double* v1, const int* inc, const double* v2,
                        const int* inc2);
//   extern "C" std::complex<float>  cdot_(const int *size,const std::complex<float> * v1,const int
//   *inc,const std::complex<float> *v2,const int *inc2);
//   extern "C" std::complex<double> zdot_(const int *size,const std::complex<double> * v1,const int
//   *inc,const std::complex<double> *v2,const int *inc2);

// ============================================================================
// = Level 3 BLAS             GEMM
// ============================================================================
extern "C" void sgemm_(char*, char*, int*, int*, int*, const float*, const float*, int*,
                       const float*, int*, const float*, float*, int*);
extern "C" void dgemm_(char*, char*, int*, int*, int*, const double*, const double*, int*,
...
extern "C" void ssymm_(char*, char*, int*, int*, const float*, const float*, int*, const float*,
                       int*, const float*, const float*, int*);
extern "C" void dsymm_(char*, char*, int*, int*, const double*, const double*, int*, const double*,
                       int*, const double*, const double*, int*);
extern "C" void csymm_(char*, char*, int*, int*, const std::complex<float>*,
                       const std::complex<float>*, int*, const std::complex<float>*, int*,
                       const std::complex<float>*, const std::complex<float>*, int*);
extern "C" void zsymm_(char*, char*, int*, int*, const std::complex<double>*,
                       const std::complex<double>*, int*, const std::complex<double>*, int*,
                       const std::complex<double>*, const std::complex<double>*, int*);
...
extern "C" void ssyrk_(char*, char*, int*, int*, const float*, const float*, int*, const float*,
                       float*, int*);
extern "C" void dsyrk_(char*, char*, int*, int*, const double*, const double*, int*, const double*,
                       double*, int*);
...
// *                          SYR2K
// ****************************************************************************
extern "C" void ssyr2k_(char*, char*, int*, int*, const float*, const float*, int*, const float*,
                        int*, const float*, float*, int*);
extern "C" void dsyr2k_(char*, char*, int*, int*, const double*, const double*, int*, const double*,
                        int*, const double*, double*, int*);
extern "C" void csyr2k_(char*, char*, int*, int*, const std::complex<float>*,
                        const std::complex<float>*, int*, const std::complex<float>*, int*,
                        const std::complex<float>*, std::complex<float>*, int*);
extern "C" void zsyr2k_(char*, char*, int*, int*, const std::complex<double>*,
                        const std::complex<double>*, int*, const std::complex<double>*, int*,
                        const std::complex<double>*, std::complex<double>*, int*);
// ****************************************************************************
// *                          HER2k
// ****************************************************************************
extern "C" void cher2k_(char*, char*, int*, int*, const std::complex<float>*,
                        const std::complex<float>*, int*, const std::complex<float>*, int*,
                        const std::complex<float>*, std::complex<float>*, int*);
extern "C" void zher2k_(char*, char*, int*, int*, const std::complex<double>*,
                        const std::complex<double>*, int*, const std::complex<double>*, int*,
                        const std::complex<double>*, std::complex<double>*, int*);
// ****************************************************************************
// *                          TRMM
// ****************************************************************************
extern "C" void strmm_(char*, char*, char*, char*, int*, int*, const float*, const float*, int*,
                       float*, int*);
extern "C" void dtrmm_(char*, char*, char*, char*, int*, int*, const double*, const double*, int*,
                       double*, int*);
...
// *                          TRSM
// ****************************************************************************
extern "C" void strsm_(char*, char*, char*, char*, int*, int*, const float*, const float*, int*,
                       float*, int*);
extern "C" void dtrsm_(char*, char*, char*, char*, int*, int*, const double*, const double*, int*,
                       double*, int*);
...
// *    Level 2 BLAS          GEMV
// ****************************************************************************
extern "C" void sgemv_(char*, int*, int*, const float*, const float*, int*, const float*, int*,
                       const float*, float*, int*);
extern "C" void dgemv_(char*, int*, int*, const double*, const double*, int*, const double*, int*,
...
// *                          HEMV
// ****************************************************************************
extern "C" void chemv_(char*, int*, const std::complex<float>*, const std::complex<float>*, int*,
                       const std::complex<float>*, int*, const std::complex<float>*,
                       std::complex<float>*, int*);
extern "C" void zhemv_(char*, int*, const std::complex<double>*, const std::complex<double>*, int*,
                       const std::complex<double>*, int*, const std::complex<double>*,
                       std::complex<double>*, int*);
// ****************************************************************************
// *                         HBMV
...
// *                         SYMV
// ******************************************************************************
extern "C" void ssymv_(char*, int*, const float*, const float*, int*, const float*, int*,
                       const float*, float*, int*);
...
// *                         SBMV
// ******************************************************************************
extern "C" void ssbmv_(char*, int*, int*, const float*, const float*, int*, const float*, int*,
                       const float*, float*, int*);
...
extern "C" void sspmv_(char*, int*, const float*, const float*, const float*, int*, const float*,
                       float*, int*);
extern "C" void dspmv_(char*, int*, const double*, const double*, const double*, int*,
                       const double*, double*, int*);
// ******************************************************************************
// *                         TRMV
// ******************************************************************************
...
extern "C" void ctpmv_(char*, char*, char*, int*, const std::complex<float>*, std::complex<float>*,
                       int*);
...
extern "C" void ctpsv_(char*, char*, char*, int*, const std::complex<float>*, std::complex<float>*,
                       int*);
...
// *                         GER
// ******************************************************************************
extern "C" void sger_(int*, int*, const float*, const float*, int*, const float*, int*, float*, int*);
extern "C" void dger_(int*, int*, const double*, const double*, int*, const double*, int*, double*,
                      int*);
// ******************************************************************************
// *                         GERU
// ******************************************************************************
extern "C" void cgeru_(int*, int*, const std::complex<float>*, const std::complex<float>*, int*,
                       const std::complex<float>*, int*, std::complex<float>*, int*);
extern "C" void zgeru_(int*, int*, const std::complex<double>*, const std::complex<double>*, int*,
                       const std::complex<double>*, int*, std::complex<double>*, int*);
// ******************************************************************************
// *                         GERC
// ******************************************************************************
extern "C" void cgerc_(int*, int*, const std::complex<float>*, const std::complex<float>*, int*,
                       const std::complex<float>*, int*, std::complex<float>*, int*);
extern "C" void zgerc_(int*, int*, const std::complex<double>*, const std::complex<double>*, int*,
                       const std::complex<double>*, int*, std::complex<double>*, int*);
// ******************************************************************************
// *                         HER
// ******************************************************************************
extern "C" void cher_(char*, int*, const std::complex<float>*, const std::complex<float>*, int*,
                      std::complex<float>*, int*);
extern "C" void zher_(char*, int*, const std::complex<double>*, const std::complex<double>*, int*,
                      std::complex<double>*, int*);
// ******************************************************************************
// *                         HPR
// ******************************************************************************
extern "C" void chpr_(char*, int*, const std::complex<float>*, const std::complex<float>*, int*,
                      std::complex<float>*);
extern "C" void zhpr_(char*, int*, const std::complex<double>*, const std::complex<double>*, int*,
                      std::complex<float>*);
// ******************************************************************************
// *                         HER2
// ******************************************************************************
extern "C" void cher2_(char*, int*, const std::complex<float>*, const std::complex<float>*, int*,
                       const std::complex<float>*, int*, std::complex<float>*, int*);
extern "C" void zher2_(char*, int*, const std::complex<double>*, const std::complex<double>*, int*,
                       const std::complex<double>*, int*, std::complex<double>*, int*);
// ******************************************************************************
// *                         HPR2
// ******************************************************************************
extern "C" void chpr2_(char*, int*, const std::complex<float>*, const std::complex<float>*, int*,
                       const std::complex<float>*, int*, std::complex<float>*);
extern "C" void zhpr2_(char*, int*, const std::complex<double>*, const std::complex<double>*, int*,
...
// *                         SYR2
// ******************************************************************************
extern "C" void ssyr2_(char*, int*, const float*, const float*, int*, const float*, int*, float*,
                       int*);
extern "C" void dsyr2_(char*, int*, const double*, const double*, int*, const double*, int*,
                       double*, int*);
// ******************************************************************************
// *                         SPR2
// ******************************************************************************
extern "C" void sspr2_(char*, int*, const float*, const float*, int*, const float*, int*, float*);
extern "C" void dspr2_(char*, int*, const double*, const double*, int*, const double*, int*, double*);
// ******************************************************************************
// *Level 1 BLAS
// ******************************************************************************
...
// ============================================================================
inline void GEMM(char c1, char c2, int sX, int sY, int sZ, const float& a, const float* x, int sx,
                 const float* y, int sy, const float& b, float* z, int sz) {
  sgemm_(&c1, &c2, &sX, &sY, &sZ, &a, x, &sx, y, &sy, &b, z, &sz);
}

inline void GEMM(char c1, char c2, int sX, int sY, int sZ, const double& a, const double* x, int sx,
                 const double* y, int sy, const double& b, double* z, int sz) {
  dgemm_(&c1, &c2, &sX, &sY, &sZ, &a, x, &sx, y, &sy, &b, z, &sz);
}

inline void GEMM(char c1, char c2, int sX, int sY, int sZ, const std::complex<float>& a,
                 const std::complex<float>* x, int sx, const std::complex<float>* y, int sy,
...
inline void GEMM(char c1, char c2, int sX, int sY, int sZ, const std::complex<double>& a,
                 const std::complex<double>* x, int sx, const std::complex<double>* y, int sy,
                 const std::complex<double>& b, std::complex<double>* z, int sz) {
  zgemm_(&c1, &c2, &sX, &sY, &sZ, &a, x, &sx, y, &sy, &b, z, &sz);
}

// ***************************************************************************
inline void SYMM(char c1, char c2, int sX, int sY, const float& a, const float* x, int sx,
                 const float* y, int sy, const float& b, float* z, int sz) {
  ssymm_(&c1, &c2, &sX, &sY, &a, x, &sx, y, &sy, &b, z, &sz);
}

inline void SYMM(char c1, char c2, int sX, int sY, const double& a, const double* x, int sx,
                 const double* y, int sy, const double& b, double* z, int sz) {
...
// }
// **************************************************************************
inline void SYRK(char UPLO, char TRANS, int N, int K, const float& ALPHA, const float* A, int LDA,
                 const float& BETA, float* C, int LDC) {
  ssyrk_(&UPLO, &TRANS, &N, &K, &ALPHA, A, &LDA, &BETA, C, &LDC);
}
inline void SYRK(char UPLO, char TRANS, int N, int K, const double& ALPHA, const double* A, int LDA,
...
// ***************************************************************************
inline void SYR2K(char uplo, char trans, int n, int k, const float& alpha, const float* A, int lda,
                  const float* B, int ldb, const float& beta, float* C, int ldc) {
  ssyr2k_(&uplo, &trans, &n, &k, &alpha, A, &lda, B, &ldb, &beta, C, &ldc);
}
inline void SYR2K(char uplo, char trans, int n, int k, const double& alpha, const double* A,
...
inline void GEMV(char c, int M, int N, const float& alpha, const float* A, int ldA, const float* x,
                 int incX, const float& beta, float* y, int incY) {
  sgemv_(&c, &M, &N, &alpha, A, &ldA, x, &incX, &beta, y, &incY);
}
// ----------------------------------------------------------------------------
inline void GEMV(char c, int M, int N, const double& alpha, const double* A, int ldA,
                 const double* x, int incX, const double& beta, double* y, int incY) {
  dgemv_(&c, &M, &N, &alpha, A, &ldA, x, &incX, &beta, y, &incY);
}
// ---------------------------------------------------------------------------
inline void GEMV(char c, int M, int N, const std::complex<float>& alpha,
...
// ---------------------------------------------------------------------------
inline void GEMV(char c, int M, int N, const std::complex<double>& alpha,
...
inline void HPMV(char uplo, int n, const std::complex<double>& alpha,
...
// ****************************************************************************
inline void SPMV(char uplo, int n, const float& alpha, const float* ap, const float* x, int incx,
                 const float& beta, float* y, int incy) {
  sspmv_(&uplo, &n, &alpha, ap, x, &incx, &beta, y, &incy);
}
inline void SPMV(char uplo, int n, const double& alpha, const double* ap, const double* x, int incx,
                 const double& beta, double* y, int incy) {
  dspmv_(&uplo, &n, &alpha, ap, x, &incx, &beta, y, &incy);
}
// ****************************************************************************
inline void TRMV(char uplo, char trans, char diag, int n, const float* a, int lda, float* x,
                 int incx) {
  strmv_(&uplo, &trans, &diag, &n, a, &lda, x, &incx);
}
inline void TRMV(char uplo, char trans, char diag, int n, const double* a, int lda, double* x,
                 int incx) {
...
// ****************************************************************************
inline void TBMV(char uplo, char trans, char diag, int n, int k, const float* a, int lda, float* x,
                 int incx) {
...
// ****************************************************************************
inline void TRSV(char uplo, char trans, char diag, int n, const float* a, int lda, float* x,
                 int incx) {
  strsv_(&uplo, &trans, &diag, &n, a, &lda, x, &incx);
}
inline void TRSV(char uplo, char trans, char diag, int n, const double* a, int lda, double* x,
                 int incx) {
...
// ****************************************************************************
inline void TBSV(char uplo, char trans, char diag, int n, int k, const float* a, int lda, float* x,
                 int incx) {
...
// ****************************************************************************
inline void GERU(int m, int n, const std::complex<float>& alpha, const std::complex<float>* x,
                 int incx, const std::complex<float>* y, int incy, std::complex<float>* a, int lda) {
  cgeru_(&m, &n, &alpha, x, &incx, y, &incy, a, &lda);
}
inline void GERU(int m, int n, const std::complex<double>& alpha, const std::complex<double>* x,
                 int incx, const std::complex<double>* y, int incy, std::complex<double>* a, int lda) {
  zgeru_(&m, &n, &alpha, x, &incx, y, &incy, a, &lda);
}
// ****************************************************************************
inline void GERC(int m, int n, const std::complex<float>& alpha, const std::complex<float>* x,
                 int incx, const std::complex<float>* y, int incy, std::complex<float>* a, int lda) {
  cgerc_(&m, &n, &alpha, x, &incx, y, &incy, a, &lda);
}
inline void GERC(int m, int n, const std::complex<double>& alpha, const std::complex<double>* x,
                 int incx, const std::complex<double>* y, int incy, std::complex<double>* a, int lda) {
  zgerc_(&m, &n, &alpha, x, &incx, y, &incy, a, &lda);
}
// *****************************************************************************
inline void HER(char uplo, int n, const std::complex<float>& alpha, const std::complex<float>* x,
                int incx, std::complex<float>* a, int lda) {
  cher_(&uplo, &n, &alpha, x, &incx, a, &lda);
}
inline void HER(char uplo, int n, const std::complex<double>& alpha, const std::complex<double>* x,
                int incx, std::complex<double>* a, int lda) {
  zher_(&uplo, &n, &alpha, x, &incx, a, &lda);
}
// *****************************************************************************
inline void HPR(char uplo, int n, const std::complex<float>& alpha, const std::complex<float>* x,
                int incx, std::complex<float>* ap) {
  chpr_(&uplo, &n, &alpha, x, &incx, ap);
}
inline void HPR(char uplo, int n, const std::complex<double>& alpha, const std::complex<double>* x,
                int incx, std::complex<float>* ap) {
  zhpr_(&uplo, &n, &alpha, x, &incx, ap);
}
// *****************************************************************************
inline void HER2(char uplo, int n, const std::complex<float>& alpha, const std::complex<float>* x,
                 int incx, const std::complex<float>* y, int incy, std::complex<float>* a, int lda) {
  cher2_(&uplo, &n, &alpha, x, &incx, y, &incy, a, &lda);
}
inline void HER2(char uplo, int n, const std::complex<double>& alpha, const std::complex<double>* x,
                 int incx, const std::complex<double>* y, int incy, std::complex<double>* a, int lda) {
  zher2_(&uplo, &n, &alpha, x, &incx, y, &incy, a, &lda);
}
// *****************************************************************************
inline void HPR2(char uplo, int n, const std::complex<float>& alpha, const std::complex<float>* x,
                 int incx, const std::complex<float>* y, int incy, std::complex<float>* ap) {
  chpr2_(&uplo, &n, &alpha, x, &incx, y, &incy, ap);
}
inline void HPR2(char uplo, int n, const std::complex<double>& alpha, const std::complex<double>* x,
                 int incx, const std::complex<double>* y, int incy, std::complex<double>* ap) {
  zhpr2_(&uplo, &n, &alpha, x, &incx, y, &incy, ap);
}
// *****************************************************************************
inline void SYR(char uplo, int n, const float& alpha, const float* x, int incx, float* a, int lda) {
  ssyr_(&uplo, &n, &alpha, x, &incx, a, &lda);
}
inline void SYR(char uplo, int n, const double& alpha, const double* x, int incx, double* a, int lda) {
...
// ****************************************************************************
inline void SYR2(char uplo, int n, const float& alpha, const float* x, int incx, const float* y,
                 int incy, float* a, int lda) {
  ssyr2_(&uplo, &n, &alpha, x, &incx, y, &incy, a, &lda);
}
inline void SYR2(char uplo, int n, const double& alpha, const double* x, int incx, const double* y,
                 int incy, double* a, int lda) {
  dsyr2_(&uplo, &n, &alpha, x, &incx, y, &incy, a, &lda);
}
// ****************************************************************************
inline void SPR2(char uplo, int n, const float& alpha, const float* x, int incx, const float* y,
                 int incy, float* ap) {
  sspr2_(&uplo, &n, &alpha, x, &incx, y, &incy, ap);
}
inline void SPR2(char uplo, int n, const double& alpha, const double* x, int incx, const double* y,
                 int incy, double* ap) {
...
inline void AXPY(int size, const float& a, const float* x, int sx, float* y, int sy) {
  saxpy_(&size, &a, x, &sx, y, &sy);
}

inline void AXPY(int size, const double& a, const double* x, int sx, double* y, int sy) {
  daxpy_(&size, &a, x, &sx, y, &sy);
}

inline void AXPY(int size, const std::complex<float>& a, const std::complex<float>* x, int sx,
                 std::complex<float>* y, int sy) {
  caxpy_(&size, &a, x, &sx, y, &sy);
}

inline void AXPY(int size, const std::complex<double>& a, const std::complex<double>* x, int sx,
                 std::complex<double>* y, int sy) {
  zaxpy_(&size, &a, x, &sx, y, &sy);
}
// ----------------------------------------------------------------------------
inline void COPY(int size, const float* x, int sx, float* y, int sy) {
  scopy_(&size, x, &sx, y, &sy);
}

inline void COPY(int size, const double* x, int sx, double* y, int sy) {
  dcopy_(&size, x, &sx, y, &sy);
}

inline void COPY(int size, const std::complex<float>* x, int sx, std::complex<float>* y, int sy) {
  ccopy_(&size, x, &sx, y, &sy);
}

inline void COPY(int size, const std::complex<double>* x, int sx, std::complex<double>* y, int sy) {
  zcopy_(&size, x, &sx, y, &sy);
}
// ----------------------------------------------------------------------------
inline void SCAL(int size, const float& a, float* y, int sy) {
  sscal_(&size, &a, y, &sy);
}

inline void SCAL(int size, const double& a, double* y, int sy) {
  dscal_(&size, &a, y, &sy);
}

inline void SCAL(int size, const std::complex<float>& a, std::complex<float>* y, int sy) {
  cscal_(&size, &a, y, &sy);
}

inline void SCAL(int size, const std::complex<double>& a, std::complex<double>* y, int sy) {
  zscal_(&size, &a, y, &sy);
}
