...
namespace LIN_ALG 
{
  namespace COPY_FROM_CPU_to_GPU 
  {
    ...
    template void memcopy_2D_h_to_d(bool*   source_ptr, const std::pair<int, int>& source_c_s, const std::pair<int, int>& source_g_s, 
				    bool*   target_ptr, const std::pair<int, int>& target_c_s, const std::pair<int, int>& target_g_s);
    template void memcopy_2D_h_to_d(int*    source_ptr, const std::pair<int, int>& source_c_s, const std::pair<int, int>& source_g_s, 
				    int*    target_ptr, const std::pair<int, int>& target_c_s, const std::pair<int, int>& target_g_s);
    template void memcopy_2D_h_to_d(float*  source_ptr, const std::pair<int, int>& source_c_s, const std::pair<int, int>& source_g_s, 
				    float*  target_ptr, const std::pair<int, int>& target_c_s, const std::pair<int, int>& target_g_s);
    template void memcopy_2D_h_to_d(double* source_ptr, const std::pair<int, int>& source_c_s, const std::pair<int, int>& source_g_s, 
    ...
    template void memcopy_2D_h_to_d_async(bool*   source_ptr, const std::pair<int, int>& source_c_s, const std::pair<int, int>& source_g_s,
					  bool*   target_ptr, const std::pair<int, int>& target_c_s, const std::pair<int, int>& target_g_s, int thread_id, int stream_id);
    template void memcopy_2D_h_to_d_async(int*    source_ptr, const std::pair<int, int>& source_c_s, const std::pair<int, int>& source_g_s, 
					  int*    target_ptr, const std::pair<int, int>& target_c_s, const std::pair<int, int>& target_g_s, int thread_id, int stream_id);
    template void memcopy_2D_h_to_d_async(float*  source_ptr, const std::pair<int, int>& source_c_s, const std::pair<int, int>& source_g_s, 
					  float*  target_ptr, const std::pair<int, int>& target_c_s, const std::pair<int, int>& target_g_s, int thread_id, int stream_id);
    template void memcopy_2D_h_to_d_async(double* source_ptr, const std::pair<int, int>& source_c_s, const std::pair<int, int>& source_g_s, 
