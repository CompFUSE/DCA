...
template <class CONCUR>
void SolverConfiguration::write(io::Writer<CONCUR>& writer, const std::string& stamp) const {
...
template void SolverConfiguration::write<Concurrency>(io::Writer<Concurrency>& writer,
                                                      const std::string& stamp) const;
template void SolverConfiguration::write<dca::parallel::NoConcurrency>(
