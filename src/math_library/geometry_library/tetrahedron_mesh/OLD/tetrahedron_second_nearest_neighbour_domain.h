...
public:
  ...
  {
    static FUNC_LIB::function<int, dmn_2<k_dmn_t, dmn_0<this_type> > >& f = initialize_function();
...
private:
  ...
  static FUNC_LIB::function<int, dmn_2<k_dmn_t, dmn_0<this_type> > >& initialize_function()
  {
    std::vector<element_type>& k_vecs = k_dmn_t::get_elements();
    std::vector<element_type>& n_vecs = this_type::get_elements();
    
    static FUNC_LIB::function<int, dmn_2<k_dmn_t, dmn_0<this_type> > > f;
