...
template<typename scalartype>  
std::vector<scalartype> statistical_methods<scalartype>::auto_correlation_time(std::vector<scalartype>& vec)
{
  int N = vec.size();
...
template<typename scalartype>  
std::vector<scalartype> statistical_methods<scalartype>::auto_correlation_time_2(std::vector<scalartype>& vec)
{
  int N = vec.size();
