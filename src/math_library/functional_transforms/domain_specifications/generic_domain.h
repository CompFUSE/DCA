...
namespace MATH_ALGORITHMS
{
  ...
  /*! 
   *  \ingroup TRAFOR-DOMAINS
   *
   *  \brief  A generic domain
   *  \author Peter Staar
   *
   *  \version 1.0
   *  \date    2013
  ...
  template<DOMAIN_NAMES NAME, typename dmn_specs_type>
  typename generic_domain<NAME, dmn_specs_type>::scalar_type*& generic_domain<NAME, dmn_specs_type>::get_min()
  {
  ...
  template<DOMAIN_NAMES NAME, typename dmn_specs_type>
  typename generic_domain<NAME, dmn_specs_type>::scalar_type*& generic_domain<NAME, dmn_specs_type>::get_max()
  {
  ...
  template<DOMAIN_NAMES NAME, typename dmn_specs_type>
  std::vector<typename generic_domain<NAME, dmn_specs_type>::element_type>& generic_domain<NAME, dmn_specs_type>::get_elements()
  {
