...
#ifndef BASIS_FUNCTION_HERMITE_CUBIC_SPLINE_EQUIDISTANT_PERIODIC_2D_H
#define BASIS_FUNCTION_HERMITE_CUBIC_SPLINE_EQUIDISTANT_PERIODIC_2D_H

namespace MATH_ALGORITHMS
{
  template<typename lh_dmn_type, typename rh_dmn_type>
  class hermite_cubic_spline<lh_dmn_type, rh_dmn_type, EQUIDISTANT, PERIODIC, 2>
  {
  private:
