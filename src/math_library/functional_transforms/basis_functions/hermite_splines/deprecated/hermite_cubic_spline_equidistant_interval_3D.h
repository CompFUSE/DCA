...
#ifndef BASIS_FUNCTION_HERMITE_CUBIC_SPLINE_EQUIDISTANT_INTERVAL_3D_H
#define BASIS_FUNCTION_HERMITE_CUBIC_SPLINE_EQUIDISTANT_INTERVAL_3D_H

namespace math_algorithms
{
  template<typename lh_dmn_type, typename rh_dmn_type>
  struct hermite_cubic_spline<lh_dmn_type, rh_dmn_type, EQUIDISTANT, INTERVAL, 3>
  {
