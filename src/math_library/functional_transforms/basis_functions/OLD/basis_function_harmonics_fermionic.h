...
#ifndef BASIS_FUNCTION_HARMONICS_FERMIONIC_H
#define BASIS_FUNCTION_HARMONICS_FERMIONIC_H

namespace TRAFOR
{

  template<typename lh_dmn_type, typename rh_dmn_type>
  class basis_function<lh_dmn_type, rh_dmn_type, HARMONICS_FERMIONIC>
  {
  public:
  ...
  public:
    ...
    static f_scalar_type execute(lh_element_type& lh_elem, rh_element_type& rh_elem)
    {
      ...
      //double renorm = lh_dmn_type::get_volume();

      return std::exp(-I*phase);///renorm;
    }
