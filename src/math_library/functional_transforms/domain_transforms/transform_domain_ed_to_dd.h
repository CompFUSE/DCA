...
#ifndef BASIS_TRANSFORMATIONS_ED_TO_DD_H
#define BASIS_TRANSFORMATIONS_ED_TO_DD_H
...
namespace MATH_ALGORITHMS
{
  ...
  class TRANSFORM_DOMAIN<type_input, EXPANSION, type_output, DISCRETE, DMN_INDEX> : public TRANSFORM_DOMAIN_PROCEDURE<DMN_INDEX>
  {
  private:
