...
#ifndef MATH_LIBRARY_FUNCTIONAL_TRANSFORMS_BASIS_TRANSFORMS_BASIS_TRANSFORMATION_ED_TO_DD_H
#define MATH_LIBRARY_FUNCTIONAL_TRANSFORMS_BASIS_TRANSFORMS_BASIS_TRANSFORMATION_ED_TO_DD_H
...
class basis_transformation<input_type, EXPANSION, output_type, DISCRETE> {
public:
...
public:
  ...
  static void initialize_transformation_matrix() {
    GENERIC_ASSERT<EXPANSION == rh_spec_dmn_type::DOMAIN_REPRESENTATION>::execute();
    GENERIC_ASSERT<DISCRETE == lh_spec_dmn_type::DOMAIN_REPRESENTATION>::execute();
...
#endif  // MATH_LIBRARY_FUNCTIONAL_TRANSFORMS_BASIS_TRANSFORMS_BASIS_TRANSFORMATION_ED_TO_DD_H
