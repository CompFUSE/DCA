...
#ifndef MATH_ALGORITHMS_NFFT_TIME_DOMAIN_H
#define MATH_ALGORITHMS_NFFT_TIME_DOMAIN_H
  ...
  namespace NFFT
  {
    ...
    public:
      ...
      typedef domain_specifications<scalar_type, element_type   ,
                                    ...
                                    PERIODIC   , EQUIDISTANT    > discrete_periodic_dmn_1D_type;
	  ...
	  //cout << "\n\n\n\n\n\t\t " << __FUNCTION__ << " " << get_name() << "\n\n\n\n\n";
          ...
          switch(NAME)
            ...
            case PADDED:
              {
                /*!
                 *   \tau \in [-0.5-2*OVER_SAMPLING, -0.5-2*OVER_SAMPLING+delta, -0.5-2*OVER_SAMPLING+2*\delta, ... , 0.5+2*OVER_SAMPLING-\delta]
                 */
