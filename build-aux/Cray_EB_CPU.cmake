...
# set by EB.
set(NFFT_DIR $ENV{EBROOTNFFT} CACHE FILEPATH "Path to NFFT installation directory.")
set(SPGLIB_DIR $ENV{EBROOTSPGLIB} CACHE FILEPATH "Path to spglib installation directory.")
set(gtest_DIR $ENV{EBROOTGTEST} CACHE FILEPATH "Path to Google Test.")
set(SPRNG_DIR $ENV{EBROOTSPRNG}  CACHE FILEPATH "Path to SPRNG installation directory.")
